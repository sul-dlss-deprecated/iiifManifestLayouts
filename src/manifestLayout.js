...
var manifestLayout = function(options) {
    ...
    function gridAlign(frames, canvasHeight, canvasWidth, lineWidth) {
        ...
        return frames.map(function(frame, index) {
            ...
            // The canvases must get their x and y properties
    ...
    //     var canvas = framingStrategies[framingStrategy];
    ...
    //         return frame([canvas(pruneCanvas(canvas),
    //                               canvasWidth,
    //                               canvasHeight
    //                              )],
    //                        framePadding,
    ...
    //     // Take each frame and mutate it to encompass
    //     // facing pages, then use options to further
    //     // mutate their x, y, width, and height coordinates
    //     // to position them appropriately.
    //     return align(bindPages(frames, viewingHint, viewingDirection, facingCanvasPadding),
    //                  canvasHeight,
    //                  canvasWidth,
    //                  containerWidth,
    //                  viewingDirection
    ...
    function intermediateLayout(viewport) {
        ...
        return layout().map(function(frame, index, frames) {
            // search frames for those in the same line.
            ...
            frame.x = 'some function',
            frame.y = 'somethingototehr',
            canvas.x = '',
            canvas.y = '';
        });
    }

    function focusLayout(frames, selected, viewport) {
        return frames.map
    }
