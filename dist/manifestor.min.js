...
a.console.assert(b.x>0,"[Viewport.resetContentSize] contentSize.x must be greater than 0"),a.console.assert(b.y>0,"[Viewport.resetContentSize] contentSize.y must be greater than 0"),this.setHomeBounds(new a.Rect(0,0,1,b.y/b.x),b.x),this},setHomeBounds:function(b,c){a.console.assert(b,"[Viewport.setHomeBounds] bounds is required"),a.console.assert(b instanceof a.Rect,"[Viewport.setHomeBounds] bounds must be an OpenSeadragon.Rect"),a.console.assert(b.width>0,"[Viewport.setHomeBounds] bounds.width must be greater than 0"),a.console.assert(b.height>0,"[Viewport.setHomeBounds] bounds.height must be greater than 0"),this.homeBounds=b.clone(),this.contentSize=this.homeBounds.getSize().times(c),this.contentAspectX=this.contentSize.x/this.contentSize.y,this.contentAspectY=this.contentSize.y/this.contentSize.x,this.viewer&&this.viewer.raiseEvent("reset-size",{contentSize:this.contentSize.clone(),contentFactor:c,homeBounds:this.homeBounds.clone()})},getHomeZoom:function(){if(this.defaultZoomLevel)return this.defaultZoomLevel;var a,b=this.contentAspectX/this.getAspectRatio();return a=this.homeFillsViewer?b>=1?b:1:b>=1?1:b,a/this.homeBounds.width},getHomeBounds:function(){var b=this.homeBounds.getCenter(),c=1/this.getHomeZoom(),d=c/this.getAspectRatio();return new a.Rect(b.x-c/2,b.y-d/2,c,d)},goHome:function(a){return this.viewer&&this.viewer.raiseEvent("home",{immediately:a}),this.fitBounds(this.getHomeBounds(),a)},getMinZoom:function(){var a=this.getHomeZoom(),b=this.minZoomLevel?this.minZoomLevel:this.minZoomImageRatio*a;return b},getMaxZoom:function(){var a=this.maxZoomLevel;return a||(a=this.contentSize.x*this.maxZoomPixelRatio/this._containerInnerSize.x,a/=this.homeBounds.width),Math.max(a,this.getHomeZoom())},getAspectRatio:function(){return this._containerInnerSize.x/this._containerInnerSize.y},getContainerSize:function(){return new a.Point(this.containerSize.x,this.containerSize.y)},getMargins:function(){return a.extend({},this._margins)},setMargins:function(b){a.console.assert("object"===a.type(b),"[Viewport.setMargins] margins must be an object"),this._margins=a.extend({left:0,top:0,right:0,bottom:0},b),this._updateContainerInnerSize(),this.viewer.forceRedraw()},getBounds:function(b){var c=this.getCenter(b),d=1/this.getZoom(b),e=d/this.getAspectRatio();return new a.Rect(c.x-d/2,c.y-e/2,d,e)},getBoundsWithMargins:function(a){var b=this.getBounds(a),c=this._containerInnerSize.x*this.getZoom(a);return b.x-=this._margins.left/c,b.y-=this._margins.top/c,b.width+=(this._margins.left+this._margins.right)/c,b.height+=(this._margins.top+this._margins.bottom)/c,b},getCenter:function(b){var c,d,e,f,g,h,i,j,k=new a.Point(this.centerSpringX.current.value,this.centerSpringY.current.value),l=new a.Point(this.centerSpringX.target.value,this.centerSpringY.target.value);return b?k:this.zoomPoint?(c=this.pixelFromPoint(this.zoomPoint,!0),d=this.getZoom(),e=1/d,f=e/this.getAspectRatio(),g=new a.Rect(k.x-e/2,k.y-f/2,e,f),h=this._pixelFromPoint(this.zoomPoint,g),i=h.minus(c),j=i.divide(this._containerInnerSize.x*d),l.plus(j)):l},getZoom:function(a){return a?this.zoomSpring.current.value:this.zoomSpring.target.value},_applyBoundaryConstraints:function(b,c){var d=0,e=0,f=new a.Rect(b.x,b.y,b.width,b.height),g=this.visibilityRatio*f.width,h=this.visibilityRatio*f.height;if(this.wrapHorizontal);else{var i=f.x+(f.width-g);this.homeBounds.x>i&&(d=this.homeBounds.x-i);var j=this.homeBounds.x+this.homeBounds.width,k=f.x+g;if(k>j){var l=j-k;d=d?(d+l)/2:l}}if(this.wrapVertical);else{var m=f.y+(f.height-h);this.homeBounds.y>m&&(e=this.homeBounds.y-m);var n=this.homeBounds.y+this.homeBounds.height,o=f.y+h;if(o>n){var p=n-o;e=e?(e+p)/2:p}}return(d||e)&&(f.x+=d,f.y+=e),this.viewer&&this.viewer.raiseEvent("constrain",{immediately:c}),f},applyConstraints:function(a){var b,c,d=this.getZoom(),e=Math.max(Math.min(d,this.getMaxZoom()),this.getMinZoom());return d!=e&&this.zoomTo(e,this.zoomPoint,a),b=this.getBounds(),c=this._applyBoundaryConstraints(b,a),(b.x!==c.x||b.y!==c.y||a)&&this.fitBounds(c,a),this},ensureVisible:function(a){return this.applyConstraints(a)},_fitBounds:function(b,c){c=c||{};var d,e,f,g,h,i,j=c.immediately||!1,k=c.constraints||!1,l=this.getAspectRatio(),m=b.getCenter(),n=new a.Rect(b.x,b.y,b.width,b.height);return n.getAspectRatio()>=l?(n.height=b.width/l,n.y=m.y-n.height/2):(n.width=b.height*l,n.x=m.x-n.width/2),k&&(h=n.getAspectRatio()),this.panTo(this.getCenter(!0),!0),this.zoomTo(this.getZoom(!0),null,!0),d=this.getBounds(),e=this.getZoom(),f=1/n.width,k&&(i=Math.max(Math.min(f,this.getMaxZoom()),this.getMinZoom()),f!==i&&(f=i,n.width=1/f,n.x=m.x-n.width/2,n.height=n.width/h,n.y=m.y-n.height/2),n=this._applyBoundaryConstraints(n,j),m=n.getCenter()),j?(this.panTo(m,!0),this.zoomTo(f,null,!0)):Math.abs(f-e)<1e-8||Math.abs(n.width-d.width)<1e-8?this.panTo(m,j):(g=d.getTopLeft().times(this._containerInnerSize.x/d.width).minus(n.getTopLeft().times(this._containerInnerSize.x/n.width)).divide(this._containerInnerSize.x/d.width-this._containerInnerSize.x/n.width),this.zoomTo(f,g,j))},fitBounds:function(a,b){return this._fitBounds(a,{immediately:b,constraints:!1})},fitBoundsWithConstraints:function(a,b){return this._fitBounds(a,{immediately:b,constraints:!0})},fitVertically:function(b){var c=new a.Rect(this.homeBounds.x+this.homeBounds.width/2,this.homeBounds.y,0,this.homeBounds.height);return this.fitBounds(c,b)},fitHorizontally:function(b){var c=new a.Rect(this.homeBounds.x,this.homeBounds.y+this.homeBounds.height/2,this.homeBounds.width,0);return this.fitBounds(c,b)},panBy:function(b,c){var d=new a.Point(this.centerSpringX.target.value,this.centerSpringY.target.value);return b=b.rotate(-this.degrees,new a.Point(0,0)),this.panTo(d.plus(b),c)},panTo:function(a,b){return b?(this.centerSpringX.resetTo(a.x),this.centerSpringY.resetTo(a.y)):(this.centerSpringX.springTo(a.x),this.centerSpringY.springTo(a.y)),this.viewer&&this.viewer.raiseEvent("pan",{center:a,immediately:b}),this},zoomBy:function(b,c,d){return c instanceof a.Point&&!isNaN(c.x)&&!isNaN(c.y)&&(c=c.rotate(-this.degrees,new a.Point(this.centerSpringX.target.value,this.centerSpringY.target.value))),this.zoomTo(this.zoomSpring.target.value*b,c,d)},zoomTo:function(b,c,d){return this.zoomPoint=c instanceof a.Point&&!isNaN(c.x)&&!isNaN(c.y)?c:null,d?this.zoomSpring.resetTo(b):this.zoomSpring.springTo(b),this.viewer&&this.viewer.raiseEvent("zoom",{zoom:b,refPoint:c,immediately:d}),this},setRotation:function(a){return this.viewer&&this.viewer.drawer.canRotate()?(a=(a+360)%360,this.degrees=a,this.viewer.forceRedraw(),null!==this.viewer&&this.viewer.raiseEvent("rotate",{degrees:a}),this):this},getRotation:function(){return this.degrees},resize:function(a,b){var c,d=this.getBounds(),e=d;return this.containerSize.x=a.x,this.containerSize.y=a.y,this._updateContainerInnerSize(),b&&(c=a.x/this.containerSize.x,e.width=d.width*c,e.height=e.width/this.getAspectRatio()),this.viewer&&this.viewer.raiseEvent("resize",{newContainerSize:a,maintain:b}),this.fitBounds(e,!0)},_updateContainerInnerSize:function(){this._containerInnerSize=new a.Point(Math.max(1,this.containerSize.x-(this._margins.left+this._margins.right)),Math.max(1,this.containerSize.y-(this._margins.top+this._margins.bottom)))},update:function(){var a,b,c,d;this.zoomPoint&&(a=this.pixelFromPoint(this.zoomPoint,!0)),this.zoomSpring.update(),this.zoomPoint&&this.zoomSpring.current.value!=this._oldZoom?(b=this.pixelFromPoint(this.zoomPoint,!0),c=b.minus(a),d=this.deltaPointsFromPixels(c,!0),this.centerSpringX.shiftBy(d.x),this.centerSpringY.shiftBy(d.y)):this.zoomPoint=null,this.centerSpringX.update(),this.centerSpringY.update();var e=this.centerSpringX.current.value!=this._oldCenterX||this.centerSpringY.current.value!=this._oldCenterY||this.zoomSpring.current.value!=this._oldZoom;return this._oldCenterX=this.centerSpringX.current.value,this._oldCenterY=this.centerSpringY.current.value,this._oldZoom=this.zoomSpring.current.value,e},deltaPixelsFromPoints:function(a,b){return a.times(this._containerInnerSize.x*this.getZoom(b))},deltaPointsFromPixels:function(a,b){return a.divide(this._containerInnerSize.x*this.getZoom(b))},pixelFromPoint:function(a,b){return this._pixelFromPoint(a,this.getBounds(b))},_pixelFromPoint:function(b,c){return b.minus(c.getTopLeft()).times(this._containerInnerSize.x/c.width).plus(new a.Point(this._margins.left,this._margins.top))},pointFromPixel:function(b,c){var d=this.getBounds(c);return b.minus(new a.Point(this._margins.left,this._margins.top)).divide(this._containerInnerSize.x/d.width).plus(d.getTopLeft())},_viewportToImageDelta:function(b,c){var d=this.homeBounds.width;return new a.Point(b*(this.contentSize.x/d),c*(this.contentSize.y*this.contentAspectX/d))},viewportToImageCoordinates:function(b,c){return 1==arguments.length?this.viewportToImageCoordinates(b.x,b.y):(this.viewer&&this.viewer.world.getItemCount()>1&&a.console.error("[Viewport.viewportToImageCoordinates] is not accurate with multi-image; use TiledImage.viewportToImageCoordinates instead."),this._viewportToImageDelta(b-this.homeBounds.x,c-this.homeBounds.y))},_imageToViewportDelta:function(b,c){var d=this.homeBounds.width;return new a.Point(b/this.contentSize.x*d,c/this.contentSize.y/this.contentAspectX*d)},imageToViewportCoordinates:function(b,c){if(1==arguments.length)return this.imageToViewportCoordinates(b.x,b.y);this.viewer&&this.viewer.world.getItemCount()>1&&a.console.error("[Viewport.imageToViewportCoordinates] is not accurate with multi-image; use TiledImage.imageToViewportCoordinates instead.");var d=this._imageToViewportDelta(b,c);return d.x+=this.homeBounds.x,d.y+=this.homeBounds.y,d},imageToViewportRectangle:function(b,c,d,e){var f,g,h;return 1==arguments.length?(h=b,this.imageToViewportRectangle(h.x,h.y,h.width,h.height)):(f=this.imageToViewportCoordinates(b,c),g=this._imageToViewportDelta(d,e),new a.Rect(f.x,f.y,g.x,g.y))},viewportToImageRectangle:function(b,c,d,e){var f,g,h;return 1==arguments.length?(h=b,this.viewportToImageRectangle(h.x,h.y,h.width,h.height)):(f=this.viewportToImageCoordinates(b,c),g=this._viewportToImageDelta(d,e),new a.Rect(f.x,f.y,g.x,g.y))},viewerElementToImageCoordinates:function(a){var b=this.pointFromPixel(a,!0);return this.viewportToImageCoordinates(b)},imageToViewerElementCoordinates:function(a){var b=this.imageToViewportCoordinates(a);return this.pixelFromPoint(b,!0)},windowToImageCoordinates:function(a){var b=a.minus(OpenSeadragon.getElementPosition(this.viewer.element));return this.viewerElementToImageCoordinates(b)},imageToWindowCoordinates:function(a){var b=this.imageToViewerElementCoordinates(a);return b.plus(OpenSeadragon.getElementPosition(this.viewer.element))},viewerElementToViewportCoordinates:function(a){return this.pointFromPixel(a,!0)},viewportToViewerElementCoordinates:function(a){return this.pixelFromPoint(a,!0)},windowToViewportCoordinates:function(a){var b=a.minus(OpenSeadragon.getElementPosition(this.viewer.element));return this.viewerElementToViewportCoordinates(b)},viewportToWindowCoordinates:function(a){var b=this.viewportToViewerElementCoordinates(a);return b.plus(OpenSeadragon.getElementPosition(this.viewer.element))},viewportToImageZoom:function(b){this.viewer&&this.viewer.world.getItemCount()>1&&a.console.error("[Viewport.viewportToImageZoom] is not accurate with multi-image.");var c=this.contentSize.x,d=this._containerInnerSize.x,e=this.homeBounds.width,f=d/c*e;return b*f},imageToViewportZoom:function(b){this.viewer&&this.viewer.world.getItemCount()>1&&a.console.error("[Viewport.imageToViewportZoom] is not accurate with multi-image.");var c=this.contentSize.x,d=this._containerInnerSize.x,e=this.homeBounds.width,f=c/d/e;return b*f}}}(OpenSeadragon),function(a){function b(b){b._needsDraw=!1;var d,e,g,h,i,j,l,m,n=null,o=!1,q=a.now(),r=b.viewport.getBoundsWithMargins(!0),s=b.viewport.deltaPixelsFromPoints(b.source.getPixelRatio(0),!0).x*b._scaleSpring.current.value,t=Math.max(b.source.minLevel,Math.floor(Math.log(b.minZoomImageRatio)/Math.log(2))),u=Math.min(Math.abs(b.source.maxLevel),Math.abs(Math.floor(Math.log(s/b.minPixelRatio)/Math.log(2)))),v=b.viewport.degrees;for(r.x-=b._xSpring.current.value,r.y-=b._ySpring.current.value;b.lastDrawn.length>0;)d=b.lastDrawn.pop(),d.beingDrawn=!1;if(90===v||270===v)r=r.rotate(v);else if(0!==v&&180!==v){var w=r.rotate(90);r.x-=w.width/2,r.y-=w.height/2,r.width+=w.width,r.height+=w.height}var x=r.getTopLeft(),y=r.getBottomRight();if((b.wrapHorizontal||!(y.x<0||x.x>b._worldWidthCurrent))&&(b.wrapVertical||!(y.y<0||x.y>b._worldHeightCurrent))){b.wrapHorizontal||(x.x=Math.max(x.x,0),y.x=Math.min(y.x,b._worldWidthCurrent)),b.wrapVertical||(x.y=Math.max(x.y,0),y.y=Math.min(y.y,b._worldHeightCurrent)),t=Math.min(t,u);var z;for(e=u;e>=t;e--){if(z=!1,g=b.viewport.deltaPixelsFromPoints(b.source.getPixelRatio(e),!0).x*b._scaleSpring.current.value,!o&&g>=b.minPixelRatio||e==t)z=!0,o=!0;else if(!o)continue;if(h=b.viewport.deltaPixelsFromPoints(b.source.getPixelRatio(e),!1).x*b._scaleSpring.current.value,i=b.viewport.deltaPixelsFromPoints(b.source.getPixelRatio(Math.max(b.source.getClosestLevel(b.viewport.containerSize)-1,0)),!1).x*b._scaleSpring.current.value,j=b.immediateRender?1:i,l=Math.min(1,(g-.5)/.5),m=j/Math.abs(j-h),n=c(b,o,z,e,l,m,x,y,q,n),k(b.coverage,e))break}p(b,b.lastDrawn),n&&!n.context2D&&f(b,n,q)}}function c(a,b,c,e,f,g,h,i,j,k){var l,m,o,p,q,r=a.viewport.pixelFromPoint(a.viewport.getCenter());for(a.viewer&&a.viewer.raiseEvent("update-level",{tiledImage:a,havedrawn:b,level:e,opacity:f,visibility:g,topleft:h,bottomright:i,currenttime:j,best:k}),o=a.source.getTileAtPoint(e,h.divide(a._scaleSpring.current.value)),p=a.source.getTileAtPoint(e,i.divide(a._scaleSpring.current.value)),q=a.source.getNumTiles(e),n(a.coverage,e),a.wrapHorizontal||(p.x=Math.min(p.x,q.x-1)),a.wrapVertical||(p.y=Math.min(p.y,q.y-1)),l=o.x;l<=p.x;l++)for(m=o.y;m<=p.y;m++)k=d(a,c,b,l,m,e,f,g,r,q,j,k);return k}function d(a,b,c,d,f,g,k,n,p,q,r,s){var t=e(d,f,g,a.source,a.tilesMatrix,r,q,a._worldWidthCurrent,a._worldHeightCurrent),u=b;if(a.viewer&&a.viewer.raiseEvent("update-tile",{tiledImage:a,tile:t}),m(a.coverage,g,d,f,!1),!t.exists)return s;if(c&&!u&&(l(a.coverage,g,d,f)?m(a.coverage,g,d,f,!0):u=!0),!u)return s;if(i(t,a.source.tileOverlap,a.viewport,p,n,a),!t.loaded)if(t.context2D)h(a,t);else{var v=a._tileCache.getImageRecord(t.url);if(v){var w=v.getImage();h(a,t,w)}}if(t.loaded){var x=j(a,t,d,f,g,k,r);x&&(a._needsDraw=!0)}else t.loading||(s=o(s,t));return s}function e(b,c,d,e,f,g,h,i,j){var k,l,m,n,o,p,q;return f[d]||(f[d]={}),f[d][b]||(f[d][b]={}),f[d][b][c]||(k=(h.x+b%h.x)%h.x,l=(h.y+c%h.y)%h.y,m=e.getTileBounds(d,k,l),n=e.tileExists(d,k,l),o=e.getTileUrl(d,k,l),p=e.getContext2D?e.getContext2D(d,k,l):void 0,m.x+=(b-k)/h.x,m.y+=j/i*((c-l)/h.y),f[d][b][c]=new a.Tile(d,b,c,m,n,o,p)),q=f[d][b][c],q.lastTouchTime=g,q}function f(a,b,c){b.loading=!0,a._imageLoader.addJob({src:b.url,crossOriginPolicy:a.crossOriginPolicy,callback:function(d,e){g(a,b,c,d,e)},abort:function(){b.loading=!1}})}function g(b,c,d,e,f){if(e){if(d<b.lastResetTime)return a.console.log("Ignoring tile %s loaded before reset: %s",c,c.url),void(c.loading=!1)}else if(a.console.log("Tile %s failed to load: %s - error: %s",c,c.url,f),b.viewer.raiseEvent("tile-load-failed",{tile:c,tiledImage:b,time:d,message:f}),!b.debugMode)return c.loading=!1,void(c.exists=!1);var g=function(){var a=Math.ceil(Math.log(b.source.getTileWidth(c.level))/Math.log(2));h(b,c,e,a)};b._midDraw?window.setTimeout(g,1):g()}function h(a,b,c,d){function e(){return g++,f}function f(){g--,0===g&&(b.loading=!1,b.loaded=!0,b.context2D||a._tileCache.cacheTile({image:c,tile:b,cutoff:d,tiledImage:a}),a._needsDraw=!0)}var g=0;a.viewer.raiseEvent("tile-loaded",{tile:b,tiledImage:a,image:c,getCompletionCallback:e}),e()()}function i(b,c,d,e,f,g){var h=b.bounds.getTopLeft();h.x*=g._scaleSpring.current.value,h.y*=g._scaleSpring.current.value,h.x+=g._xSpring.current.value,h.y+=g._ySpring.current.value;var i=b.bounds.getSize();i.x*=g._scaleSpring.current.value,i.y*=g._scaleSpring.current.value;var j=d.pixelFromPoint(h,!0),k=d.pixelFromPoint(h,!1),l=d.deltaPixelsFromPoints(i,!0),m=d.deltaPixelsFromPoints(i,!1),n=k.plus(m.divide(2)),o=e.distanceTo(n);c||(l=l.plus(new a.Point(1,1))),b.position=j,b.size=l,b.distance=o,b.visibility=f}function j(a,b,c,d,e,f,g){var h,i,j=1e3*a.blendTime;if(b.blendStart||(b.blendStart=g),h=g-b.blendStart,i=j?Math.min(1,h/j):1,a.alwaysBlend&&(i*=f),b.opacity=i,a.lastDrawn.push(b),1==i)m(a.coverage,e,c,d,!0),a._hasOpaqueTile=!0;else if(j>h)return!0;return!1}function k(a,b,c,d){var e,f,g,h;if(!a[b])return!1;if(void 0===c||void 0===d){e=a[b];for(g in e)if(e.hasOwnProperty(g)){f=e[g];for(h in f)if(f.hasOwnProperty(h)&&!f[h])return!1}return!0}return void 0===a[b][c]||void 0===a[b][c][d]||a[b][c][d]===!0}function l(a,b,c,d){return void 0===c||void 0===d?k(a,b+1):k(a,b+1,2*c,2*d)&&k(a,b+1,2*c,2*d+1)&&k(a,b+1,2*c+1,2*d)&&k(a,b+1,2*c+1,2*d+1)}function m(b,c,d,e,f){return b[c]?(b[c][d]||(b[c][d]={}),void(b[c][d][e]=f)):void a.console.warn("Setting coverage for a tile before its level's coverage has been reset: %s",c)}function n(a,b){a[b]={}}function o(a,b){return a?b.visibility>a.visibility?b:b.visibility==a.visibility&&b.distance<a.distance?b:a:b}function p(a,b){var c,d;if(a.opacity<=0)return void q(a,b);var e=a.opacity<1;e&&a._drawer._clear(!0);var f=!1;if(a._clip){a._drawer.saveContext(e);var g=a.imageToViewportRectangle(a._clip,!0),h=a._drawer.viewportToDrawerRectangle(g);a._drawer.setClip(h,e),f=!0}if(a.placeholderFillStyle&&a._hasOpaqueTile===!1){var i=a._drawer.viewportToDrawerRectangle(a.getBounds(!0)),j=null;j="function"==typeof a.placeholderFillStyle?a.placeholderFillStyle(a,a._drawer.context):a.placeholderFillStyle,a._drawer.drawRectangle(i,j,e)}for(c=b.length-1;c>=0;c--)d=b[c],a._drawer.drawTile(d,a._drawingHandler,e),d.beingDrawn=!0,a.viewer&&a.viewer.raiseEvent("tile-drawn",{tiledImage:a,tile:d});f&&a._drawer.restoreContext(e),e&&a._drawer.blendSketch(a.opacity),q(a,b)}function q(b,c){if(b.debugMode)for(var d=c.length-1;d>=0;d--){var e=c[d];try{b._drawer.drawDebugInfo(e,c.length,d)}catch(f){a.console.error(f)}}}a.TiledImage=function(b){var c=this;a.console.assert(b.tileCache,"[TiledImage] options.tileCache is required"),a.console.assert(b.drawer,"[TiledImage] options.drawer is required"),a.console.assert(b.viewer,"[TiledImage] options.viewer is required"),a.console.assert(b.imageLoader,"[TiledImage] options.imageLoader is required"),a.console.assert(b.source,"[TiledImage] options.source is required"),a.console.assert(!b.clip||b.clip instanceof a.Rect,"[TiledImage] options.clip must be an OpenSeadragon.Rect if present"),a.EventSource.call(this),this._tileCache=b.tileCache,delete b.tileCache,this._drawer=b.drawer,delete b.drawer,this._imageLoader=b.imageLoader,delete b.imageLoader,b.clip instanceof a.Rect&&(this._clip=b.clip.clone()),delete b.clip;var d=b.x||0;delete b.x;var e=b.y||0;delete b.y,this.normHeight=b.source.dimensions.y/b.source.dimensions.x,this.contentAspectX=b.source.dimensions.x/b.source.dimensions.y;var f=1;b.width?(f=b.width,delete b.width,b.height&&(a.console.error("specifying both width and height to a tiledImage is not supported"),delete b.height)):b.height&&(f=b.height/this.normHeight,delete b.height),a.extend(!0,this,{viewer:null,tilesMatrix:{},coverage:{},lastDrawn:[],lastResetTime:0,_midDraw:!1,_needsDraw:!0,_hasOpaqueTile:!1,springStiffness:a.DEFAULT_SETTINGS.springStiffness,animationTime:a.DEFAULT_SETTINGS.animationTime,minZoomImageRatio:a.DEFAULT_SETTINGS.minZoomImageRatio,wrapHorizontal:a.DEFAULT_SETTINGS.wrapHorizontal,wrapVertical:a.DEFAULT_SETTINGS.wrapVertical,immediateRender:a.DEFAULT_SETTINGS.immediateRender,blendTime:a.DEFAULT_SETTINGS.blendTime,alwaysBlend:a.DEFAULT_SETTINGS.alwaysBlend,minPixelRatio:a.DEFAULT_SETTINGS.minPixelRatio,debugMode:a.DEFAULT_SETTINGS.debugMode,crossOriginPolicy:a.DEFAULT_SETTINGS.crossOriginPolicy,placeholderFillStyle:a.DEFAULT_SETTINGS.placeholderFillStyle,opacity:a.DEFAULT_SETTINGS.opacity},b),this._xSpring=new a.Spring({initial:d,springStiffness:this.springStiffness,animationTime:this.animationTime}),this._ySpring=new a.Spring({initial:e,springStiffness:this.springStiffness,animationTime:this.animationTime}),this._scaleSpring=new a.Spring({initial:f,springStiffness:this.springStiffness,animationTime:this.animationTime}),this._updateForScale(),this._drawingHandler=function(b){c.viewer.raiseEvent("tile-drawing",a.extend({tiledImage:c},b))}},a.extend(a.TiledImage.prototype,a.EventSource.prototype,{needsDraw:function(){return this._needsDraw},reset:function(){this._tileCache.clearTilesFor(this),this.lastResetTime=a.now(),this._needsDraw=!0},update:function(){var a=this._xSpring.current.value,b=this._ySpring.current.value,c=this._scaleSpring.current.value;return this._xSpring.update(),this._ySpring.update(),this._scaleSpring.update(),this._xSpring.current.value!==a||this._ySpring.current.value!==b||this._scaleSpring.current.value!==c?(this._updateForScale(),this._needsDraw=!0,!0):!1},draw:function(){this._midDraw=!0,b(this),this._midDraw=!1},destroy:function(){this.reset()},getBounds:function(b){return b?new a.Rect(this._xSpring.current.value,this._ySpring.current.value,this._worldWidthCurrent,this._worldHeightCurrent):new a.Rect(this._xSpring.target.value,this._ySpring.target.value,this._worldWidthTarget,this._worldHeightTarget)},getWorldBounds:function(){return a.console.error("[TiledImage.getWorldBounds] is deprecated; use TiledImage.getBounds instead"),this.getBounds()},getContentSize:function(){return new a.Point(this.source.dimensions.x,this.source.dimensions.y)},_viewportToImageDelta:function(b,c,d){var e=d?this._scaleSpring.current.value:this._scaleSpring.target.value;return new a.Point(b*(this.source.dimensions.x/e),c*(this.source.dimensions.y*this.contentAspectX/e))},viewportToImageCoordinates:function(b,c,d){return b instanceof a.Point&&(d=c,c=b.y,b=b.x),d?this._viewportToImageDelta(b-this._xSpring.current.value,c-this._ySpring.current.value):this._viewportToImageDelta(b-this._xSpring.target.value,c-this._ySpring.target.value)},_imageToViewportDelta:function(b,c,d){var e=d?this._scaleSpring.current.value:this._scaleSpring.target.value;return new a.Point(b/this.source.dimensions.x*e,c/this.source.dimensions.y/this.contentAspectX*e)},imageToViewportCoordinates:function(b,c,d){b instanceof a.Point&&(d=c,c=b.y,b=b.x);var e=this._imageToViewportDelta(b,c);return d?(e.x+=this._xSpring.current.value,e.y+=this._ySpring.current.value):(e.x+=this._xSpring.target.value,e.y+=this._ySpring.target.value),e},imageToViewportRectangle:function(b,c,d,e,f){b instanceof a.Rect&&(f=c,d=b.width,e=b.height,c=b.y,b=b.x);var g=this.imageToViewportCoordinates(b,c,f),h=this._imageToViewportDelta(d,e,f);return new a.Rect(g.x,g.y,h.x,h.y)},viewportToImageRectangle:function(b,c,d,e,f){b instanceof a.Rect&&(f=c,d=b.width,e=b.height,c=b.y,b=b.x);var g=this.viewportToImageCoordinates(b,c,f),h=this._viewportToImageDelta(d,e,f);return new a.Rect(g.x,g.y,h.x,h.y)},viewerElementToImageCoordinates:function(a){var b=this.viewport.pointFromPixel(a,!0);return this.viewportToImageCoordinates(b)},imageToViewerElementCoordinates:function(a){var b=this.imageToViewportCoordinates(a);return this.viewport.pixelFromPoint(b,!0)},windowToImageCoordinates:function(a){var b=a.minus(OpenSeadragon.getElementPosition(this.viewer.element));return this.viewerElementToImageCoordinates(b)},imageToWindowCoordinates:function(a){var b=this.imageToViewerElementCoordinates(a);return b.plus(OpenSeadragon.getElementPosition(this.viewer.element))},viewportToImageZoom:function(a){var b=this._scaleSpring.current.value*this.viewport._containerInnerSize.x/this.source.dimensions.x;return b*a},imageToViewportZoom:function(a){var b=this._scaleSpring.current.value*this.viewport._containerInnerSize.x/this.source.dimensions.x;return a/b},setPosition:function(a,b){var c=this._xSpring.target.value===a.x&&this._ySpring.target.value===a.y;if(b){if(c&&this._xSpring.current.value===a.x&&this._ySpring.current.value===a.y)return;this._xSpring.resetTo(a.x),this._ySpring.resetTo(a.y),this._needsDraw=!0}else{if(c)return;this._xSpring.springTo(a.x),this._ySpring.springTo(a.y),this._needsDraw=!0}c||this._raiseBoundsChange()},setWidth:function(a,b){this._setScale(a,b)},setHeight:function(a,b){this._setScale(a/this.normHeight,b)},getClip:function(){return this._clip?this._clip.clone():null},setClip:function(b){a.console.assert(!b||b instanceof a.Rect,"[TiledImage.setClip] newClip must be an OpenSeadragon.Rect or null"),b instanceof a.Rect?this._clip=b.clone():this._clip=null,this._needsDraw=!0},getOpacity:function(){return this.opacity},setOpacity:function(a){this.opacity=a,this._needsDraw=!0},_setScale:function(a,b){var c=this._scaleSpring.target.value===a;if(b){if(c&&this._scaleSpring.current.value===a)return;this._scaleSpring.resetTo(a),this._updateForScale(),this._needsDraw=!0}else{if(c)return;this._scaleSpring.springTo(a),this._updateForScale(),this._needsDraw=!0}c||this._raiseBoundsChange()},_updateForScale:function(){this._worldWidthTarget=this._scaleSpring.target.value,this._worldHeightTarget=this.normHeight*this._scaleSpring.target.value,this._worldWidthCurrent=this._scaleSpring.current.value,this._worldHeightCurrent=this.normHeight*this._scaleSpring.current.value},_raiseBoundsChange:function(){this.raiseEvent("bounds-change")}})}(OpenSeadragon),function(a){var b=function(b){a.console.assert(b,"[TileCache.cacheTile] options is required"),a.console.assert(b.tile,"[TileCache.cacheTile] options.tile is required"),a.console.assert(b.tiledImage,"[TileCache.cacheTile] options.tiledImage is required"),this.tile=b.tile,this.tiledImage=b.tiledImage},c=function(b){a.console.assert(b,"[ImageRecord] options is required"),a.console.assert(b.image,"[ImageRecord] options.image is required"),this._image=b.image,this._tiles=[]};c.prototype={destroy:function(){this._image=null,this._renderedContext=null,this._tiles=null},getImage:function(){return this._image},getRenderedContext:function(){if(!this._renderedContext){var a=document.createElement("canvas");a.width=this._image.width,a.height=this._image.height,this._renderedContext=a.getContext("2d"),this._renderedContext.drawImage(this._image,0,0),this._image=null}return this._renderedContext},setRenderedContext:function(b){a.console.error("ImageRecord.setRenderedContext is deprecated. The rendered context should be created by the ImageRecord itself when calling ImageRecord.getRenderedContext."),this._renderedContext=b},addTile:function(b){a.console.assert(b,"[ImageRecord.addTile] tile is required"),this._tiles.push(b)},removeTile:function(b){for(var c=0;c<this._tiles.length;c++)if(this._tiles[c]===b)return void this._tiles.splice(c,1);a.console.warn("[ImageRecord.removeTile] trying to remove unknown tile",b)},getTileCount:function(){return this._tiles.length}},a.TileCache=function(b){b=b||{},this._maxImageCacheCount=b.maxImageCacheCount||a.DEFAULT_SETTINGS.maxImageCacheCount,this._tilesLoaded=[],this._imagesLoaded=[],this._imagesLoadedCount=0},a.TileCache.prototype={numTilesLoaded:function(){return this._tilesLoaded.length},cacheTile:function(d){a.console.assert(d,"[TileCache.cacheTile] options is required"),a.console.assert(d.tile,"[TileCache.cacheTile] options.tile is required"),a.console.assert(d.tile.url,"[TileCache.cacheTile] options.tile.url is required"),a.console.assert(d.tiledImage,"[TileCache.cacheTile] options.tiledImage is required");var e=d.cutoff||0,f=this._tilesLoaded.length,g=this._imagesLoaded[d.tile.url];if(g||(a.console.assert(d.image,"[TileCache.cacheTile] options.image is required to create an ImageRecord"),g=this._imagesLoaded[d.tile.url]=new c({image:d.image}),this._imagesLoadedCount++),g.addTile(d.tile),d.tile.cacheImageRecord=g,this._imagesLoadedCount>this._maxImageCacheCount){for(var h,i,j,k,l,m,n=null,o=-1,p=null,q=this._tilesLoaded.length-1;q>=0;q--)m=this._tilesLoaded[q],h=m.tile,h.level<=e||h.beingDrawn||(n?(k=h.lastTouchTime,i=n.lastTouchTime,l=h.level,j=n.level,(i>k||k==i&&l>j)&&(n=h,o=q,p=m)):(n=h,o=q,p=m));n&&o>=0&&(this._unloadTile(p),f=o)}this._tilesLoaded[f]=new b({tile:d.tile,tiledImage:d.tiledImage})},clearTilesFor:function(b){a.console.assert(b,"[TileCache.clearTilesFor] tiledImage is required");for(var c,d=0;d<this._tilesLoaded.length;++d)c=this._tilesLoaded[d],c.tiledImage===b&&(this._unloadTile(c),this._tilesLoaded.splice(d,1),d--)},getImageRecord:function(b){return a.console.assert(b,"[TileCache.getImageRecord] url is required"),this._imagesLoaded[b]},_unloadTile:function(b){a.console.assert(b,"[TileCache._unloadTile] tileRecord is required");var c=b.tile,d=b.tiledImage;c.unload(),c.cacheImageRecord=null;var e=this._imagesLoaded[c.url];e.removeTile(c),e.getTileCount()||(e.destroy(),delete this._imagesLoaded[c.url],this._imagesLoadedCount--),d.viewer.raiseEvent("tile-unloaded",{tile:c,tiledImage:d})}}}(OpenSeadragon),function(a){a.World=function(b){var c=this;a.console.assert(b.viewer,"[World] options.viewer is required"),a.EventSource.call(this),this.viewer=b.viewer,this._items=[],this._needsDraw=!1,this._autoRefigureSizes=!0,this._needsSizesFigured=!1,this._delegatedFigureSizes=function(a){c._autoRefigureSizes?c._figureSizes():c._needsSizesFigured=!0},this._figureSizes()},a.extend(a.World.prototype,a.EventSource.prototype,{addItem:function(b,c){if(a.console.assert(b,"[World.addItem] item is required"),a.console.assert(b instanceof a.TiledImage,"[World.addItem] only TiledImages supported at this time"),c=c||{},void 0!==c.index){var d=Math.max(0,Math.min(this._items.length,c.index));this._items.splice(d,0,b)}else this._items.push(b);this._autoRefigureSizes?this._figureSizes():this._needsSizesFigured=!0,this._needsDraw=!0,b.addHandler("bounds-change",this._delegatedFigureSizes),this.raiseEvent("add-item",{item:b})},getItemAt:function(b){return a.console.assert(void 0!==b,"[World.getItemAt] index is required"),this._items[b]},getIndexOfItem:function(b){return a.console.assert(b,"[World.getIndexOfItem] item is required"),a.indexOf(this._items,b)},getItemCount:function(){return this._items.length},setItemIndex:function(b,c){a.console.assert(b,"[World.setItemIndex] item is required"),a.console.assert(void 0!==c,"[World.setItemIndex] index is required");var d=this.getIndexOfItem(b);if(c>=this._items.length)throw new Error("Index bigger than number of layers.");c!==d&&-1!==d&&(this._items.splice(d,1),this._items.splice(c,0,b),this._needsDraw=!0,this.raiseEvent("item-index-change",{item:b,previousIndex:d,newIndex:c}))},removeItem:function(b){a.console.assert(b,"[World.removeItem] item is required");var c=a.indexOf(this._items,b);-1!==c&&(b.removeHandler("bounds-change",this._delegatedFigureSizes),b.destroy(),this._items.splice(c,1),this._figureSizes(),this._needsDraw=!0,this._raiseRemoveItem(b))},removeAll:function(){this.viewer._cancelPendingImages();for(var a,b=0;b<this._items.length;b++)a=this._items[b],a.removeHandler("bounds-change",this._delegatedFigureSizes),a.destroy();var c=this._items;for(this._items=[],this._figureSizes(),this._needsDraw=!0,b=0;b<c.length;b++)a=c[b],this._raiseRemoveItem(a)},resetItems:function(){for(var a=0;a<this._items.length;a++)this._items[a].reset()},update:function(){for(var a=!1,b=0;b<this._items.length;b++)a=this._items[b].update()||a;return a},draw:function(){for(var a=0;a<this._items.length;a++)this._items[a].draw();this._needsDraw=!1},needsDraw:function(){for(var a=0;a<this._items.length;a++)if(this._items[a].needsDraw())return!0;return this._needsDraw},getHomeBounds:function(){return this._homeBounds.clone()},getContentFactor:function(){return this._contentFactor},setAutoRefigureSizes:function(a){this._autoRefigureSizes=a,a&this._needsSizesFigured&&(this._figureSizes(),this._needsSizesFigured=!1)},arrange:function(b){b=b||{};var c,d=b.immediately||!1,e=b.layout||a.DEFAULT_SETTINGS.collectionLayout,f=b.rows||a.DEFAULT_SETTINGS.collectionRows,g=b.columns||a.DEFAULT_SETTINGS.collectionColumns,h=b.tileSize||a.DEFAULT_SETTINGS.collectionTileSize,i=b.tileMargin||a.DEFAULT_SETTINGS.collectionTileMargin,j=h+i;
c=!b.rows&&g?g:Math.ceil(this._items.length/f);var k,l,m,n,o,p=0,q=0;this.setAutoRefigureSizes(!1);for(var r=0;r<this._items.length;r++)r&&r%c===0&&("horizontal"===e?(q+=j,p=0):(p+=j,q=0)),k=this._items[r],l=k.getBounds(),m=l.width>l.height?h:h*(l.width/l.height),n=m*(l.height/l.width),o=new a.Point(p+(h-m)/2,q+(h-n)/2),k.setPosition(o,d),k.setWidth(m,d),"horizontal"===e?p+=j:q+=j;this.setAutoRefigureSizes(!0)},_figureSizes:function(){var b=this._homeBounds?this._homeBounds.clone():null,c=this._contentSize?this._contentSize.clone():null,d=this._contentFactor||0;if(this._items.length){var e=this._items[0].getBounds();this._contentFactor=this._items[0].getContentSize().x/e.width;for(var f,g=e.x,h=e.y,i=e.x+e.width,j=e.y+e.height,k=1;k<this._items.length;k++)f=this._items[k].getBounds(),this._contentFactor=Math.max(this._contentFactor,this._items[k].getContentSize().x/f.width),g=Math.min(g,f.x),h=Math.min(h,f.y),i=Math.max(i,f.x+f.width),j=Math.max(j,f.y+f.height);this._homeBounds=new a.Rect(g,h,i-g,j-h),this._contentSize=new a.Point(this._homeBounds.width*this._contentFactor,this._homeBounds.height*this._contentFactor)}else this._homeBounds=new a.Rect(0,0,1,1),this._contentSize=new a.Point(1,1),this._contentFactor=1;this._contentFactor===d&&this._homeBounds.equals(b)&&this._contentSize.equals(c)||this.raiseEvent("metrics-change",{})},_raiseRemoveItem:function(a){this.raiseEvent("remove-item",{item:a})}})}(OpenSeadragon)},{}],3:[function(a,b,c){var d=function(a){"use strict";this.id=a.id,this.label=a.label||"No Label",this.needed=a.needed||!1,this.visible=a.visible||!1,this.clipRegion=a.clipRegion,this.opacity=a.opacity||1,this.bounds=a.bounds||{x:0,y:0,width:1,height:1},this.zIndex=a.zIndex,this.tileSource=a.tileSource,this.dynamic=a.dynamic||!1,this.imageType=a.imageType||"main",this.status="initialized",this.parent=a.parent,this.dispatcher=a.parent.dispatcher};d.prototype={show:function(a){this.needed||this.setNeeded(!0),this.visible=!0,this.dispatcher.emit("image-show",this)},hide:function(a){this.visible=!1,this.dispatcher.emit("image-hide",this)},getVisible:function(){return this.visible},setNeeded:function(a){this.needed=a,a&&this.dispatcher.emit("image-needed",this)},getThumbnailNeeded:function(){return this.needed},getFullNeeded:function(){return this.needed},setOpacity:function(a){this.opacity=a,this.visible&&this.dispatcher.emit("image-opacity-updated",this)},getOpacity:function(){return this.opacity},getImageType:function(){return this.imageType},getLocalBounds:function(){return this.bounds},getGlobalBounds:function(){var a=this;return{x:this.parent.bounds.x+this.parent.bounds.width*a.bounds.x,y:this.parent.bounds.y+this.parent.bounds.width*a.bounds.y,width:this.parent.bounds.width*a.bounds.width,height:this.parent.bounds.height*a.bounds.height}},containsGlobalPoint:function(a){var b=this.getGlobalBounds(),c=b.x+b.width,d=b.y+b.height;return b.x<=a.x&&c>=a.x&&b.y<=a.y&&d>=a.y},setStatus:function(a){this.status=a,this.dispatcher.emit("image-status-updated",this)},getStatus:function(){return this.status},moveToIndex:function(a){this.parent.moveToIndex(this,a)},moveToBottom:function(){this.parent.moveToBottom(this)},moveToTop:function(a){this.parent.moveToTop(this)},insertAboveIndex:function(a,b){this.parent.insertAboveIndex(this,b)},insertBelowIndex:function(a,b){this.parent.insertBelowIndex(this,b)},insertAboveResource:function(a,b){this.parent.insertAboveResource(this,b)},insertBelowResource:function(a,b){this.parent.insertBelowResource(this,b)},moveUpOne:function(a){this.parent.moveUpOne(this)},moveDownOne:function(a){this.parent.moveDownOne(this)}},b.exports=d},{}],4:[function(a,b,c){var d=a("./ImageResource"),e=function(a){var b=a.map(function(a){return parseInt(a,10)});return{x:b[0],y:b[1],width:b[2],height:b[3]}},f=function(a){var b=a.split("#"),c=null;if(b.length>1){var d=b[1].split("=");c=e(d[1].split(","))}return c},g=function(a){if("rdf:nil"!=a){if(a.full)return g(a.full);var b=function(){return!!a.service&&"http://iiif.io/api/image/2/context.json"==a.service["@context"]&&!a.service.width},c=b(),d=a;c&&(d=a.service);var e=d["@id"],h=function(){return c?e+"/info.json":{type:"image",url:e}},i=h();return{id:e.replace(/[^a-z0-9-_]+/gi,"")+Math.floor(1e3*Math.random()),label:a.label,tileSource:i,clipRegion:f(e),dynamic:c}}},h=function(a){var b=function(a,b){var c=g(a);return c&&(c.imageType=b),c},c=[],d=b(a["default"],"main");return d&&c.push(d),a.item.forEach(function(a){var d=b(a,"alternate");d&&c.push(d)}),c},i=function(a,b){var c=a.resource["@type"],i=function(a){return{x:a.x/b.bounds.width,y:a.y/b.bounds.width,width:a.width/b.bounds.width,height:a.height/b.bounds.height}},j=function(c){if(c){c.parent=b;var e=f(a.on);return e&&(c.imageType="detail",c.bounds=i(e)),new d(c)}};switch(c){case"dctypes:Image":var k=g(a.resource);return j(k);case"oa:Choice":var l=h(a.resource);return l.map(function(a){return j(a)});case"oa:SpecificResource":var m=a.resource;if(k=g(m),k&&m.selector&&m.selector.region){var n=m.selector.region.split(",");k.clipRegion=e(n)}return j(k);default:throw new Error("Cannot create an image from type "+c)}};b.exports=i},{"./ImageResource":3}],5:[function(a,b,c){"use strict";var d=a("./ImageResource"),e="Unsupported image format for LegacyTileSource.",f=function(a){switch(a){case"image/jpeg":return"jpg";case"image/png":return"png";case"image/gif":return"gif";default:throw e}},g=function(a,b){var c=function(){return"/full/"+b+",/"},d=a["@id"];if(d.toLowerCase().match(/^.*\.(png|jpg|jpeg|gif)$/))return d.replace("/full/full/",c());var e=f(a.format);return a.service["@id"]+c()+"0/default."+e},h=function(a,b,c){return a["default"]?h(a["default"],b,c):{url:g(a,b),height:c,width:b}},i=function(a,b){var c=b.getBounds(),d=function(a){return Math.ceil(2*a)};return{tileSource:{type:"legacy-image-pyramid",levels:[h(a,d(c.width),d(c.height))]},parent:b,imageType:"thumbnail",dynamic:!1,zIndex:9999}},j=function(a,b){if(a.thumbnail)return new d(i(a.thumbnail,b));if(a.images)try{var c=i(a.images[0].resource,b);return new d(c)}catch(f){if(f==e)return;throw f}};b.exports=j},{"./ImageResource":3}],6:[function(a,b,c){var d=(a("./ImageResource"),a("./ImageResourceFactory")),e=a("./ThumbnailFactory"),f=function(a){"use strict";var b=this;this.dispatcher=a.dispatcher,this.id=a.canvas["@id"],this.label=a.canvas.label,this.canvas=a.canvas,this.clipRegion=a.clipRegion,this.opacity=a.opacity||1,this.index=a.index,this.bounds={x:a.x||0,y:a.y||0,height:a.canvas.height,width:a.canvas.width},this.viewingHint=a.canvas.viewingHint,this.images=[],a.canvas.images&&a.canvas.images.forEach(function(a){var c=d(a,b);c&&(b.images=b.images.concat(c))}),this.thumbnailResource=e(this.canvas,b)};f.prototype={containsPoint:function(a){var b=this.bounds.x+this.bounds.width,c=this.bounds.y+this.bounds.height;return this.bounds.x<=a.x&&b>=a.x&&this.bounds.y<=a.y&&c>=a.y},getVisibleImages:function(){return this.images.filter(function(a){return a.visible===!0})},getDetailImages:function(){return this.images.filter(function(a){return"detail"===a.imageType})},getAlternateImages:function(){return this.images.filter(function(a){return"alternate"===a.imageType})},getMainImage:function(){return this.images.filter(function(a){return"main"===a.imageType})[0]},getImageById:function(a){return this.images.filter(function(b){return b.id===a})[0]},getThumbnailResource:function(){return this.thumbnailResource},setBounds:function(a,b,c,d){var e=this;this.bounds.x=a,this.bounds.y=b,this.bounds.width=c,this.bounds.height=d,e.dispatcher.emit("canvas-position-updated",e)},getBounds:function(){var a=this;return{x:this.bounds.x,y:this.bounds.y,width:this.bounds.width,height:this.bounds.height,getTopLeft:function(){return{x:a.bounds.x,y:a.bounds.y}}}},getAspectRatio:function(){return this.bounds.width/this.bounds.height},getThumbnailNeeded:function(){return this.thumbnailNeeded},setThumbnailNeeded:function(a){this.thumbnailNeeded=a,a&&(this.thumbnailResource.setNeeded(!0),this.dispatcher.emit("canvas-thumbnail-needed",this))},show:function(a){this.needed||this.setNeeded(!0),this.visible=!0,this.dispatcher.emit("image-show",this)},hide:function(a){this.visible=!1,this.dispatcher.emit("image-hide",this)},getVisible:function(){return this.visible},setNeeded:function(a){this.needed=a,a&&this.dispatcher.emit("canvas-needed",this)},getNeeded:function(){return this.needed},getOpacity:function(){return this.opacity},setOpacity:function(a){this.opacity=a,this.images.forEach(function(a){a.updateOpacity()})},_floatImagesToBottom:function(){var a=0;for(a;a<this.images;a++)this.images[a].zIndex=a,this.images[a].updateItemIndex()},moveToIndex:function(a,b){this._floatImagesToBottom();var c=this.images.indexOf(a);if(console.log("old index: "+c),console.log("index: "+b),b!==c&&-1!==c){if(b>=this.images.length)throw new Error("Index bigger than number of images.");a.zIndex=b,this.images.splice(c,1),this.images.splice(b,0,a),a.updateItemIndex()}},moveToBottom:function(a){this.moveToIndex(a,0)},moveToTop:function(a){this.moveToIndex(a,this.images.length-1)},insertAboveIndex:function(a,b){0!==b&&this.moveToIndex(a,b-1)},insertBelowIndex:function(a,b){b<this.images.length-1&&this.moveToIndex(a,b+1)},insertAboveResource:function(a,b){this.insertAboveIndex(a,this.images.indexOf(b))},insertBelowResource:function(a,b){this.insertBelowIndex(a,this.images.indexOf(b))},moveUpOne:function(a){this.insertAboveResource(a,a)},moveDownOne:function(a){this.insertBelowResource(a,a)}},b.exports=f},{"./ImageResource":3,"./ImageResourceFactory":4,"./ThumbnailFactory":5}],7:[function(a,b,c){var d=a("./canvasObject"),e=function(a){"use strict";function b(a,b){var c={};return a.forEach(function(a,e){c[a["@id"]]=new d({canvas:a,index:e,dispatcher:b})}),c}this.canvases=a.canvases,this.dispatcher=a.dispatcher,this.canvasObjects=b(this.canvases,this.dispatcher)};e.prototype={isValidCanvasIndex:function(a){return a>0&&a<this.canvases.length},loadTileSourceForIndex:function(a){var b=this.canvases[a]["@id"];this.canvasObjects[b].openMainTileSource()},selectCanvasForIndex:function(a){var b=this.canvases[a]["@id"];this.selectCanvas(b)},navigatePaged:function(a,b){var c=this,d=a+b;if(a%2!==0&&(d=a+2*b),this.isValidCanvasIndex(d)){for(var e=function(a){var b=c.canvases[a]["@id"];return c.canvasObjects[b]},f=e(d);"non-paged"===f.viewingHint&&this.isValidCanvasIndex(d);)d+=b,f=e(d);var g=d+b;this.isValidCanvasIndex(g),c.electCanvasForIndex(d)}},navigateIndividual:function(a,b){var c=a+b;this.isValidCanvasIndex(c)&&this.selectCanvasForIndex(c)}},b.exports=e},{"./canvasObject":6}],8:[function(a,b,c){var d=a("./lib/d3-slim-dist"),e=function(a){this.dispatcher=a.dispatcher,this.renderState=a.renderState,this.viewerState=a.viewerState,this.scrollContainer=a.scrollContainer,this.overlays=a.overlays,this.canvasClass=a.canvasClass,this.frameClass=a.frameClass,this.labelClass=a.labelClass};e.prototype={setScrollElementEvents:function(){if(this.viewerState){var a=1200,b=d.select(this.overlays[0]),c=this.viewerState.getState();"detail"===c.perspective?(b.style("opacity",0).style("pointer-events","none"),d.select(this.scrollContainer[0]).style("pointer-events","none").style("overflow-y","hidden")):this.renderState.getState().zooming||(b.style("pointer-events","all").transition().duration(a/2).style("opacity",1),d.select(this.scrollContainer[0]).style("pointer-events","all").style("overflow-y","scroll"))}},scaleForZoom:function(a,b){var c="scale("+a+") translate("+-b.x+"px,"+-b.y+"px)";d.select(this.overlays[0]).style("transform",c).style("-webkit-transform",c)},renderLayout:function(a,b){var c=this,e=d.select(this.overlays[0]),f=b?1e3:0,g=e.selectAll("."+this.frameClass).data(a),h=function(a){return a.width+"px"},i=function(a){return a.height+"px"},j=function(a){return a.canvas.width+"px"},k=function(a){return a.canvas.height+"px"},l=function(a){return d.interpolateString(this.style.transform,"translate("+a.x+"px,"+a.y+"px)")},m=function(a){return d.interpolateString(this.style.transform,"translate("+a.canvas.localX+"px,"+a.canvas.localY+"px)")},n=function(a){return"translate("+a.x+"px,"+a.y+"px)"},o=function(a){return"translateX("+a.canvas.localX+"px) translateY("+a.canvas.localY+"px)"},p=function(a){var b=a.canvas.selected;return b?c.canvasClass+" selected":c.canvasClass};g.style("width",h).style("height",i).transition().duration(f).ease("cubic-out").styleTween("transform",l).styleTween("-webkit-transform",l).tween("translateTilesources",function(a,b){var e=c.viewerState.getState().canvasObjects[a.canvas.id],f=e.getBounds(),g=d.interpolate(f.x,a.canvas.x),h=d.interpolate(f.y,a.canvas.y);return function(b){e.setBounds(g(b),h(b),a.canvas.width,a.canvas.height)}}).call(this._endall,function(){c.dispatcher.emit("render-layout-complete")}),g.select("."+this.canvasClass).style("width",j).style("height",k).attr("class",p).transition().duration(f).ease("cubic-out").styleTween("transform",m).styleTween("-webkit-transform",m);var q=g.enter().append("div").attr("class",this.frameClass).style("width",h).style("height",i).style("transform",n).style("-webkit-transform",n);q.append("div").attr("class",p).attr("data-id",function(a){return a.canvas.id}).style("width",j).style("height",k).style("transform",o).style("-webkit-transform",o).each(function(a){var b=a.canvas,d=c.viewerState.getState().canvasObjects[b.id];d.setBounds(b.x,b.y,b.width,b.height)}),q.append("div").attr("class",this.labelClass).text(function(a){return a.canvas.label})},_endall:function(a,b){var c=0;a.empty()?b():a.each(function(){++c}).each("end",function(){--c||b.apply(this,arguments)})}},b.exports=e},{"./lib/d3-slim-dist":10}],9:[function(a,b,c){"use strict";var d={getFirst:function(a){return a[0]["@id"]},getImageUrl:function(a){if(!a.images[0].resource.service)return b=a.images[0].resource["default"].service["@id"],b=b.replace(/\/$/,"");var b=a.images[0].resource.service["@id"];return b=b.replace(/\/$/,"")},getVersionFromContext:function(a){return"http://iiif.io/api/image/2/context.json"==a?"2.0":"1.1"},makeUriWithWidth:function(a,b,c){return a=a.replace(/\/$/,""),"1"==c[0]?a+"/full/"+b+",/0/native.jpg":a+"/full/"+b+",/0/default.jpg"},getThumbnailForCanvas:function(a,b){var c,d,e="1.1";if(b.forEach(function(a){parseInt(a,10)}),a.hasOwnProperty("thumbnail"))"string"==typeof a.thumbnail?d=a.thumbnail:a.thumbnail.hasOwnProperty("service")?(c=a.thumbnail.service,c.hasOwnProperty("@context")&&(e=this.getVersionFromContext(c["@context"])),d=this.makeUriWithWidth(c["@id"],width,e)):d=a.thumbnail["@id"];else{var f=a.images[0].resource;c=f["default"]?f["default"].service:f.service,c.hasOwnProperty("@context")&&(e=this.iiif.getVersionFromContext(c["@context"])),d=this.iiif.makeUriWithWidth(c["@id"],width,e)}return d}};b.exports=d},{}],10:[function(a,b,c){!function(){function a(a){return a&&(a.ownerDocument||a.document||a).documentElement}function c(a){return a&&(a.ownerDocument&&a.ownerDocument.defaultView||a.document&&a||a.defaultView)}function d(a,b){if(b in a)return b;b=b.charAt(0).toUpperCase()+b.slice(1);for(var c=0,d=Ya.length;d>c;++c){var e=Ya[c]+b;if(e in a)return e}}function e(a){return Xa(a,ab),a}function f(a){return"function"==typeof a?a:function(){return Za(a,this)}}function g(a){return"function"==typeof a?a:function(){return $a(a,this)}}function h(a,b){function c(){this.removeAttribute(a)}function d(){this.removeAttributeNS(a.space,a.local)}function e(){this.setAttribute(a,b)}function f(){this.setAttributeNS(a.space,a.local,b)}function g(){var c=b.apply(this,arguments);null==c?this.removeAttribute(a):this.setAttribute(a,c)}function h(){var c=b.apply(this,arguments);null==c?this.removeAttributeNS(a.space,a.local):this.setAttributeNS(a.space,a.local,c)}return a=Ta.ns.qualify(a),null==b?a.local?d:c:"function"==typeof b?a.local?h:g:a.local?f:e}function i(a){return a.trim().replace(/\s+/g," ")}function j(a){return new RegExp("(?:^|\\s+)"+Ta.requote(a)+"(?:\\s+|$)","g")}function k(a){return(a+"").trim().split(/^|\s+/)}function l(a,b){function c(){for(var c=-1;++c<e;)a[c](this,b)}function d(){for(var c=-1,d=b.apply(this,arguments);++c<e;)a[c](this,d)}a=k(a).map(m);var e=a.length;return"function"==typeof b?d:c}function m(a){var b=j(a);return function(c,d){if(e=c.classList)return d?e.add(a):e.remove(a);var e=c.getAttribute("class")||"";d?(b.lastIndex=0,b.test(e)||c.setAttribute("class",i(e+" "+a))):c.setAttribute("class",i(e.replace(b," ")))}}function n(a,b,c){function d(){this.style.removeProperty(a)}function e(){this.style.setProperty(a,b,c)}function f(){var d=b.apply(this,arguments);null==d?this.style.removeProperty(a):this.style.setProperty(a,d,c)}return null==b?d:"function"==typeof b?f:e}function o(a,b){function c(){delete this[a]}function d(){this[a]=b}function e(){var c=b.apply(this,arguments);null==c?delete this[a]:this[a]=c}return null==b?c:"function"==typeof b?e:d}function p(a){function b(){var b=this.ownerDocument,c=this.namespaceURI;return c?b.createElementNS(c,a):b.createElement(a)}function c(){return this.ownerDocument.createElementNS(a.space,a.local)}return"function"==typeof a?a:(a=Ta.ns.qualify(a)).local?c:b}function q(){var a=this.parentNode;a&&a.removeChild(this)}function r(a,b){for(var c in b)Object.defineProperty(a.prototype,c,{value:b[c],enumerable:!1})}function s(){this._=Object.create(null)}function t(a){return(a+="")===db||a[0]===eb?eb+a:a}function u(a){return(a+="")[0]===eb?a.slice(1):a}function v(a){return t(a)in this._}function w(a){return(a=t(a))in this._&&delete this._[a]}function x(){var a=[];for(var b in this._)a.push(u(b));return a}function y(){var a=0;for(var b in this._)++a;return a}function z(){for(var a in this._)return!1;return!0}function A(){this._=Object.create(null)}function B(a){return{__data__:a}}function C(a){return function(){return _a(this,a)}}function D(a,b){return b>a?-1:a>b?1:a>=b?0:NaN}function E(a){return arguments.length||(a=D),function(b,c){return b&&c?a(b.__data__,c.__data__):!b-!c}}function F(){}function G(){}function H(a){function b(){for(var b,d=c,e=-1,f=d.length;++e<f;)(b=d[e].on)&&b.apply(this,arguments);return a}var c=[],d=new s;return b.on=function(b,e){var f,g=d.get(b);return arguments.length<2?g&&g.on:(g&&(g.on=null,c=c.slice(0,f=c.indexOf(g)).concat(c.slice(f+1)),d.remove(b)),e&&c.push(d.set(b,{on:e})),a)},b}function I(a,b,c){function d(){var b=this[g];b&&(this.removeEventListener(a,b,b.$),delete this[g])}function e(){var e=i(b,Va(arguments));d.call(this),this.addEventListener(a,this[g]=e,e.$=c),e._=b}function f(){var b,c=new RegExp("^__on([^.]+)"+Ta.requote(a)+"$");for(var d in this)if(b=d.match(c)){var e=this[d];this.removeEventListener(b[1],e,e.$),delete this[d]}}var g="__on"+a,h=a.indexOf("."),i=J;h>0&&(a=a.slice(0,h));var j=fb.get(a);return j&&(a=j,i=K),h?b?e:d:b?F:f}function J(a,b){return function(c){var d=Ta.event;Ta.event=c,b[0]=this.__data__;try{a.apply(this,b)}finally{Ta.event=d}}}function K(a,b){var c=J(a,b);return function(a){var b=this,d=a.relatedTarget;d&&(d===b||8&d.compareDocumentPosition(b))||c.call(b,a)}}function L(a,b){for(var c=0,d=a.length;d>c;c++)for(var e,f=a[c],g=0,h=f.length;h>g;g++)(e=f[g])&&b(e,g,c);return a}function M(a){return Xa(a,gb),a}function N(a){var b,c;return function(d,e,f){var g,h=a[f].update,i=h.length;for(f!=c&&(c=f,b=0),e>=b&&(b=e+1);!(g=h[b])&&++b<i;);return g}}function O(a,b,c){var d=arguments.length;2>d&&(b=0),3>d&&(c=Date.now());var e=c+b,f={c:a,t:e,n:null};return ib?ib.n=f:hb=f,ib=f,jb||(kb=clearTimeout(kb),jb=1,lb(P)),f}function P(){var a=Q(),b=R()-a;b>24?(isFinite(b)&&(clearTimeout(kb),kb=setTimeout(P,b)),jb=0):(jb=1,lb(P))}function Q(){for(var a=Date.now(),b=hb;b;)a>=b.t&&b.c(a-b.t)&&(b.c=null),b=b.n;return a}function R(){for(var a,b=hb,c=1/0;b;)b.c?(b.t<c&&(c=b.t),b=(a=b).n):b=a?a.n=b.n:hb=b.n;return ib=a,c}function S(a){return function(){var b,c,d;(b=this[a])&&(d=b[c=b.active])&&(d.timer.c=null,d.timer.t=NaN,--b.count?delete b[c]:delete this[a],b.active+=.5,d.event&&d.event.interrupt.call(this,this.__data__,d.index))}}function T(a,b,c){return Xa(a,pb),a.namespace=b,a.id=c,a}function U(){}function V(a,b,c){return this instanceof V?(this.h=+a,this.s=+b,void(this.l=+c)):arguments.length<2?a instanceof V?new V(a.h,a.s,a.l):ga(""+a,ha,V):new V(a,b,c)}function W(a,b,c){function d(a){return a>360?a-=360:0>a&&(a+=360),60>a?f+(g-f)*a/60:180>a?g:240>a?f+(g-f)*(240-a)/60:f}function e(a){return Math.round(255*d(a))}var f,g;return a=isNaN(a)?0:(a%=360)<0?a+360:a,b=isNaN(b)?0:0>b?0:b>1?1:b,c=0>c?0:c>1?1:c,g=.5>=c?c*(1+b):c+b-c*b,f=2*c-g,new da(e(a+120),e(a),e(a-120))}function X(a,b,c){return this instanceof X?(this.h=+a,this.c=+b,void(this.l=+c)):arguments.length<2?a instanceof X?new X(a.h,a.c,a.l):a instanceof Z?_(a.l,a.a,a.b):_((a=ia((a=Ta.rgb(a)).r,a.g,a.b)).l,a.a,a.b):new X(a,b,c)}function Y(a,b,c){return isNaN(a)&&(a=0),isNaN(b)&&(b=0),new Z(c,Math.cos(a*=vb)*b,Math.sin(a)*b)}function Z(a,b,c){return this instanceof Z?(this.l=+a,this.a=+b,void(this.b=+c)):arguments.length<2?a instanceof Z?new Z(a.l,a.a,a.b):a instanceof X?Y(a.h,a.c,a.l):ia((a=da(a)).r,a.g,a.b):new Z(a,b,c)}function $(a,b,c){var d=(a+16)/116,e=d+b/500,f=d-c/200;return e=aa(e)*zb,d=aa(d)*Ab,f=aa(f)*Bb,new da(ca(3.2404542*e-1.5371385*d-.4985314*f),ca(-.969266*e+1.8760108*d+.041556*f),ca(.0556434*e-.2040259*d+1.0572252*f))}function _(a,b,c){return a>0?new X(Math.atan2(c,b)*wb,Math.sqrt(b*b+c*c),a):new X(NaN,NaN,a)}function aa(a){return a>.206893034?a*a*a:(a-4/29)/7.787037}function ba(a){return a>.008856?Math.pow(a,1/3):7.787037*a+4/29}function ca(a){return Math.round(255*(.00304>=a?12.92*a:1.055*Math.pow(a,1/2.4)-.055))}function da(a,b,c){return this instanceof da?(this.r=~~a,this.g=~~b,void(this.b=~~c)):arguments.length<2?a instanceof da?new da(a.r,a.g,a.b):ga(""+a,da,W):new da(a,b,c)}function ea(a){return new da(a>>16,a>>8&255,255&a)}function fa(a){return 16>a?"0"+Math.max(0,a).toString(16):Math.min(255,a).toString(16)}function ga(a,b,c){var d,e,f,g=0,h=0,i=0;if(d=/([a-z]+)\((.*)\)/.exec(a=a.toLowerCase()))switch(e=d[2].split(","),d[1]){case"hsl":return c(parseFloat(e[0]),parseFloat(e[1])/100,parseFloat(e[2])/100);case"rgb":return b(ka(e[0]),ka(e[1]),ka(e[2]))}return(f=Eb.get(a))?b(f.r,f.g,f.b):(null==a||"#"!==a.charAt(0)||isNaN(f=parseInt(a.slice(1),16))||(4===a.length?(g=(3840&f)>>4,g=g>>4|g,h=240&f,h=h>>4|h,i=15&f,i=i<<4|i):7===a.length&&(g=(16711680&f)>>16,h=(65280&f)>>8,i=255&f)),b(g,h,i))}function ha(a,b,c){var d,e,f=Math.min(a/=255,b/=255,c/=255),g=Math.max(a,b,c),h=g-f,i=(g+f)/2;return h?(e=.5>i?h/(g+f):h/(2-g-f),d=a==g?(b-c)/h+(c>b?6:0):b==g?(c-a)/h+2:(a-b)/h+4,d*=60):(d=NaN,e=i>0&&1>i?0:d),new V(d,e,i)}function ia(a,b,c){a=ja(a),b=ja(b),c=ja(c);var d=ba((.4124564*a+.3575761*b+.1804375*c)/zb),e=ba((.2126729*a+.7151522*b+.072175*c)/Ab),f=ba((.0193339*a+.119192*b+.9503041*c)/Bb);return Z(116*e-16,500*(d-e),200*(e-f))}function ja(a){return(a/=255)<=.04045?a/12.92:Math.pow((a+.055)/1.055,2.4)}function ka(a){var b=parseFloat(a);return"%"===a.charAt(a.length-1)?Math.round(2.55*b):b}function la(a,b){a=Ta.rgb(a),b=Ta.rgb(b);var c=a.r,d=a.g,e=a.b,f=b.r-c,g=b.g-d,h=b.b-e;return function(a){return"#"+fa(Math.round(c+f*a))+fa(Math.round(d+g*a))+fa(Math.round(e+h*a))}}function ma(a,b){var c,d={},e={};for(c in a)c in b?d[c]=qa(a[c],b[c]):e[c]=a[c];for(c in b)c in a||(e[c]=b[c]);return function(a){for(c in d)e[c]=d[c](a);return e}}function na(a,b){var c,d=[],e=[],f=a.length,g=b.length,h=Math.min(a.length,b.length);for(c=0;h>c;++c)d.push(qa(a[c],b[c]));for(;f>c;++c)e[c]=a[c];for(;g>c;++c)e[c]=b[c];return function(a){for(c=0;h>c;++c)e[c]=d[c](a);return e}}function oa(a,b){return a=+a,b=+b,function(c){return a*(1-c)+b*c}}function pa(a,b){var c,d,e,f=Fb.lastIndex=Gb.lastIndex=0,g=-1,h=[],i=[];for(a+="",b+="";(c=Fb.exec(a))&&(d=Gb.exec(b));)(e=d.index)>f&&(e=b.slice(f,e),h[g]?h[g]+=e:h[++g]=e),(c=c[0])===(d=d[0])?h[g]?h[g]+=d:h[++g]=d:(h[++g]=null,i.push({i:g,x:oa(c,d)})),f=Gb.lastIndex;return f<b.length&&(e=b.slice(f),h[g]?h[g]+=e:h[++g]=e),h.length<2?i[0]?(b=i[0].x,function(a){return b(a)+""}):function(){return b}:(b=i.length,function(a){for(var c,d=0;b>d;++d)h[(c=i[d]).i]=c.x(a);return h.join("")})}function qa(a,b){for(var c,d=Ta.interpolators.length;--d>=0&&!(c=Ta.interpolators[d](a,b)););return c}function ra(a){var b=[a.a,a.b],c=[a.c,a.d],d=ta(b),e=sa(b,c),f=ta(ua(c,b,-e))||0;b[0]*c[1]<c[0]*b[1]&&(b[0]*=-1,b[1]*=-1,d*=-1,e*=-1),this.rotate=(d?Math.atan2(b[1],b[0]):Math.atan2(-c[0],c[1]))*wb,this.translate=[a.e,a.f],this.scale=[d,f],this.skew=f?Math.atan2(e,f)*wb:0}function sa(a,b){return a[0]*b[0]+a[1]*b[1]}function ta(a){var b=Math.sqrt(sa(a,a));return b&&(a[0]/=b,a[1]/=b),b}function ua(a,b,c){return a[0]+=c*b[0],a[1]+=c*b[1],a}function va(a){return a.length?a.pop()+",":""}function wa(a,b,c,d){if(a[0]!==b[0]||a[1]!==b[1]){var e=c.push("translate(",null,",",null,")");d.push({i:e-4,x:oa(a[0],b[0])},{i:e-2,x:oa(a[1],b[1])})}else(b[0]||b[1])&&c.push("translate("+b+")")}function xa(a,b,c,d){a!==b?(a-b>180?b+=360:b-a>180&&(a+=360),d.push({i:c.push(va(c)+"rotate(",null,")")-2,x:oa(a,b)})):b&&c.push(va(c)+"rotate("+b+")")}function ya(a,b,c,d){a!==b?d.push({i:c.push(va(c)+"skewX(",null,")")-2,x:oa(a,b)}):b&&c.push(va(c)+"skewX("+b+")")}function za(a,b,c,d){if(a[0]!==b[0]||a[1]!==b[1]){var e=c.push(va(c)+"scale(",null,",",null,")");d.push({i:e-4,x:oa(a[0],b[0])},{i:e-2,x:oa(a[1],b[1])})}else(1!==b[0]||1!==b[1])&&c.push(va(c)+"scale("+b+")")}function Aa(a,b){var c=[],d=[];return a=Ta.transform(a),b=Ta.transform(b),wa(a.translate,b.translate,c,d),xa(a.rotate,b.rotate,c,d),ya(a.skew,b.skew,c,d),za(a.scale,b.scale,c,d),a=b=null,function(a){for(var b,e=-1,f=d.length;++e<f;)c[(b=d[e]).i]=b.x(a);return c.join("")}}function Ba(a,b,c,d){var e=a.id,f=a.namespace;return L(a,"function"==typeof c?function(a,g,h){a[f][e].tween.set(b,d(c.call(a,a.__data__,g,h)))}:(c=d(c),function(a){a[f][e].tween.set(b,c)}))}function Ca(a){return null==a&&(a=""),function(){this.textContent=a}}function Da(a){return a}function Ea(a){return function(b){return 0>=b?0:b>=1?1:a(b)}}function Fa(a){return function(b){return 1-a(1-b)}}function Ga(a){return function(b){return.5*(.5>b?a(2*b):2-a(2-2*b))}}function Ha(a){return a*a}function Ia(a){return a*a*a}function Ja(a){if(0>=a)return 0;if(a>=1)return 1;var b=a*a,c=b*a;return 4*(.5>a?c:3*(a-b)+c-.75)}function Ka(a){return function(b){return Math.pow(b,a)}}function La(a){return 1-Math.cos(a*ub)}function Ma(a){return Math.pow(2,10*(a-1))}function Na(a){return 1-Math.sqrt(1-a*a)}function Oa(a,b){var c;return arguments.length<2&&(b=.45),arguments.length?c=b/tb*Math.asin(1/a):(a=1,c=b/4),function(d){return 1+a*Math.pow(2,-10*d)*Math.sin((d-c)*tb/b)}}function Pa(a){return a||(a=1.70158),function(b){return b*b*((a+1)*b-a)}}function Qa(a){return 1/2.75>a?7.5625*a*a:2/2.75>a?7.5625*(a-=1.5/2.75)*a+.75:2.5/2.75>a?7.5625*(a-=2.25/2.75)*a+.9375:7.5625*(a-=2.625/2.75)*a+.984375}function Ra(a){return null==a?"__transition__":"__transition_"+a+"__"}function Sa(a,b,c,d,e){function f(a){var b=o.delay;return j.t=b+i,a>=b?g(a-b):void(j.c=g)}function g(c){var e=n.active,f=n[e];f&&(f.timer.c=null,f.timer.t=NaN,--n.count,delete n[e],f.event&&f.event.interrupt.call(a,a.__data__,f.index));for(var g in n)if(d>+g){var p=n[g];p.timer.c=null,p.timer.t=NaN,--n.count,delete n[g]}n.active=d,o.event&&o.event.start.call(a,a.__data__,b),m=[],o.tween.forEach(function(c,d){(d=d.call(a,a.__data__,b))&&m.push(d)}),l=o.ease,k=o.duration,j.c=h,O(function(){return j.c&&h(c||1)&&(j.c=null,j.t=NaN),1},0,i)}function h(e){for(var f=e/k,g=l(f),h=m.length;h>0;)m[--h].call(a,g);return f>=1?(o.event&&o.event.end.call(a,a.__data__,b),--n.count?delete n[d]:delete a[c],1):void 0}var i,j,k,l,m,n=a[c]||(a[c]={active:0,count:0}),o=n[d];o||(i=e.time,j=O(f,0,i),o=n[d]={tween:new s,time:i,timer:j,delay:e.delay,duration:e.duration,ease:e.ease,index:b},e=null,++n.count)}var Ta={version:"3.5.8"},Ua=[].slice,Va=function(a){return Ua.call(a)},Wa=this.document,Xa={}.__proto__?function(a,b){a.__proto__=b}:function(a,b){for(var c in b)a[c]=b[c]},Ya=["webkit","ms","moz","Moz","o","O"],Za=function(a,b){return b.querySelector(a)},$a=function(a,b){return b.querySelectorAll(a)},_a=function(a,b){var c=a.matches||a[d(a,"matchesSelector")];return(_a=function(a,b){return c.call(a,b)})(a,b)};"function"==typeof Sizzle&&(Za=function(a,b){return Sizzle(a,b)[0]||null},$a=Sizzle,_a=Sizzle.matchesSelector),Ta.selection=function(){return Ta.select(Wa.documentElement)};var ab=Ta.selection.prototype=[];ab.select=function(a){var b,c,d,g,h=[];a=f(a);for(var i=-1,j=this.length;++i<j;){h.push(b=[]),b.parentNode=(d=this[i]).parentNode;for(var k=-1,l=d.length;++k<l;)(g=d[k])?(b.push(c=a.call(g,g.__data__,k,i)),c&&"__data__"in g&&(c.__data__=g.__data__)):b.push(null)}return e(h)},ab.selectAll=function(a){var b,c,d=[];a=g(a);for(var f=-1,h=this.length;++f<h;)for(var i=this[f],j=-1,k=i.length;++j<k;)(c=i[j])&&(d.push(b=Va(a.call(c,c.__data__,j,f))),b.parentNode=c);return e(d)};var bb={svg:"http://www.w3.org/2000/svg",xhtml:"http://www.w3.org/1999/xhtml",xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace",xmlns:"http://www.w3.org/2000/xmlns/"};Ta.ns={prefix:bb,qualify:function(a){var b=a.indexOf(":"),c=a;return b>=0&&"xmlns"!==(c=a.slice(0,b))&&(a=a.slice(b+1)),bb.hasOwnProperty(c)?{space:bb[c],local:a}:a}},ab.attr=function(a,b){if(arguments.length<2){if("string"==typeof a){var c=this.node();return a=Ta.ns.qualify(a),a.local?c.getAttributeNS(a.space,a.local):c.getAttribute(a)}for(b in a)this.each(h(b,a[b]));return this}return this.each(h(a,b))},Ta.requote=function(a){return a.replace(cb,"\\$&")};var cb=/[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g;ab.classed=function(a,b){if(arguments.length<2){if("string"==typeof a){var c=this.node(),d=(a=k(a)).length,e=-1;if(b=c.classList){for(;++e<d;)if(!b.contains(a[e]))return!1}else for(b=c.getAttribute("class");++e<d;)if(!j(a[e]).test(b))return!1;return!0}for(b in a)this.each(l(b,a[b]));return this}return this.each(l(a,b))},ab.style=function(a,b,d){var e=arguments.length;if(3>e){if("string"!=typeof a){2>e&&(b="");for(d in a)this.each(n(d,a[d],b));return this}if(2>e){var f=this.node();return c(f).getComputedStyle(f,null).getPropertyValue(a)}d=""}return this.each(n(a,b,d))},ab.property=function(a,b){if(arguments.length<2){if("string"==typeof a)return this.node()[a];for(b in a)this.each(o(b,a[b]));return this}return this.each(o(a,b))},ab.text=function(a){return arguments.length?this.each("function"==typeof a?function(){var b=a.apply(this,arguments);this.textContent=null==b?"":b}:null==a?function(){this.textContent=""}:function(){this.textContent=a}):this.node().textContent},ab.html=function(a){return arguments.length?this.each("function"==typeof a?function(){var b=a.apply(this,arguments);this.innerHTML=null==b?"":b}:null==a?function(){this.innerHTML=""}:function(){this.innerHTML=a}):this.node().innerHTML},ab.append=function(a){return a=p(a),this.select(function(){return this.appendChild(a.apply(this,arguments))})},ab.insert=function(a,b){return a=p(a),b=f(b),this.select(function(){return this.insertBefore(a.apply(this,arguments),b.apply(this,arguments)||null)})},ab.remove=function(){return this.each(q)},Ta.map=function(a,b){var c=new s;if(a instanceof s)a.forEach(function(a,b){c.set(a,b)});else if(Array.isArray(a)){var d,e=-1,f=a.length;if(1===arguments.length)for(;++e<f;)c.set(e,a[e]);else for(;++e<f;)c.set(b.call(a,d=a[e],e),d)}else for(var g in a)c.set(g,a[g]);return c};var db="__proto__",eb="\x00";r(s,{has:v,get:function(a){return this._[t(a)]},set:function(a,b){return this._[t(a)]=b},remove:w,keys:x,values:function(){var a=[];for(var b in this._)a.push(this._[b]);return a},entries:function(){var a=[];for(var b in this._)a.push({key:u(b),value:this._[b]});return a},size:y,empty:z,forEach:function(a){for(var b in this._)a.call(this,u(b),this._[b])}}),Ta.set=function(a){var b=new A;if(a)for(var c=0,d=a.length;d>c;++c)b.add(a[c]);return b},r(A,{has:v,add:function(a){return this._[t(a+="")]=!0,a},remove:w,values:x,size:y,empty:z,forEach:function(a){for(var b in this._)a.call(this,u(b))}}),ab.data=function(a,b){
function c(a,c){var d,e,f,g=a.length,h=c.length,l=Math.min(g,h),m=new Array(h),n=new Array(h),o=new Array(g);if(b){var p,q=new s,r=new Array(g);for(d=-1;++d<g;)(e=a[d])&&(q.has(p=b.call(e,e.__data__,d))?o[d]=e:q.set(p,e),r[d]=p);for(d=-1;++d<h;)(e=q.get(p=b.call(c,f=c[d],d)))?e!==!0&&(m[d]=e,e.__data__=f):n[d]=B(f),q.set(p,!0);for(d=-1;++d<g;)d in r&&q.get(r[d])!==!0&&(o[d]=a[d])}else{for(d=-1;++d<l;)e=a[d],f=c[d],e?(e.__data__=f,m[d]=e):n[d]=B(f);for(;h>d;++d)n[d]=B(c[d]);for(;g>d;++d)o[d]=a[d]}n.update=m,n.parentNode=m.parentNode=o.parentNode=a.parentNode,i.push(n),j.push(m),k.push(o)}var d,f,g=-1,h=this.length;if(!arguments.length){for(a=new Array(h=(d=this[0]).length);++g<h;)(f=d[g])&&(a[g]=f.__data__);return a}var i=M([]),j=e([]),k=e([]);if("function"==typeof a)for(;++g<h;)c(d=this[g],a.call(d,d.parentNode.__data__,g));else for(;++g<h;)c(d=this[g],a);return j.enter=function(){return i},j.exit=function(){return k},j},ab.datum=function(a){return arguments.length?this.property("__data__",a):this.property("__data__")},ab.filter=function(a){var b,c,d,f=[];"function"!=typeof a&&(a=C(a));for(var g=0,h=this.length;h>g;g++){f.push(b=[]),b.parentNode=(c=this[g]).parentNode;for(var i=0,j=c.length;j>i;i++)(d=c[i])&&a.call(d,d.__data__,i,g)&&b.push(d)}return e(f)},ab.order=function(){for(var a=-1,b=this.length;++a<b;)for(var c,d=this[a],e=d.length-1,f=d[e];--e>=0;)(c=d[e])&&(f&&f!==c.nextSibling&&f.parentNode.insertBefore(c,f),f=c);return this},Ta.ascending=D,ab.sort=function(a){a=E.apply(this,arguments);for(var b=-1,c=this.length;++b<c;)this[b].sort(a);return this.order()},Ta.dispatch=function(){for(var a=new G,b=-1,c=arguments.length;++b<c;)a[arguments[b]]=H(a);return a},G.prototype.on=function(a,b){var c=a.indexOf("."),d="";if(c>=0&&(d=a.slice(c+1),a=a.slice(0,c)),a)return arguments.length<2?this[a].on(d):this[a].on(d,b);if(2===arguments.length){if(null==b)for(a in this)this.hasOwnProperty(a)&&this[a].on(d,null);return this}},Ta.event=null,ab.on=function(a,b,c){var d=arguments.length;if(3>d){if("string"!=typeof a){2>d&&(b=!1);for(c in a)this.each(I(c,a[c],b));return this}if(2>d)return(d=this.node()["__on"+a])&&d._;c=!1}return this.each(I(a,b,c))};var fb=Ta.map({mouseenter:"mouseover",mouseleave:"mouseout"});Wa&&fb.forEach(function(a){"on"+a in Wa&&fb.remove(a)}),ab.each=function(a){return L(this,function(b,c,d){a.call(b,b.__data__,c,d)})},ab.call=function(a){var b=Va(arguments);return a.apply(b[0]=this,b),this},ab.empty=function(){return!this.node()},ab.node=function(){for(var a=0,b=this.length;b>a;a++)for(var c=this[a],d=0,e=c.length;e>d;d++){var f=c[d];if(f)return f}return null},ab.size=function(){var a=0;return L(this,function(){++a}),a};var gb=[];Ta.selection.enter=M,Ta.selection.enter.prototype=gb,gb.append=ab.append,gb.empty=ab.empty,gb.node=ab.node,gb.call=ab.call,gb.size=ab.size,gb.select=function(a){for(var b,c,d,f,g,h=[],i=-1,j=this.length;++i<j;){d=(f=this[i]).update,h.push(b=[]),b.parentNode=f.parentNode;for(var k=-1,l=f.length;++k<l;)(g=f[k])?(b.push(d[k]=c=a.call(f.parentNode,g.__data__,k,i)),c.__data__=g.__data__):b.push(null)}return e(h)},gb.insert=function(a,b){return arguments.length<2&&(b=N(this)),ab.insert.call(this,a,b)},Ta.select=function(b){var c;return"string"==typeof b?(c=[Za(b,Wa)],c.parentNode=Wa.documentElement):(c=[b],c.parentNode=a(b)),e([c])},Ta.selectAll=function(a){var b;return"string"==typeof a?(b=Va($a(a,Wa)),b.parentNode=Wa.documentElement):(b=Va(a),b.parentNode=null),e([b])};var hb,ib,jb,kb,lb=this[d(this,"requestAnimationFrame")]||function(a){setTimeout(a,17)};Ta.timer=function(){O.apply(this,arguments)},Ta.timer.flush=function(){Q(),R()},ab.transition=function(a){for(var b,c,d=mb||++qb,e=Ra(a),f=[],g=nb||{time:Date.now(),ease:Ja,delay:0,duration:250},h=-1,i=this.length;++h<i;){f.push(b=[]);for(var j=this[h],k=-1,l=j.length;++k<l;)(c=j[k])&&Sa(c,k,e,d,g),b.push(c)}return T(f,e,d)},ab.interrupt=function(a){return this.each(null==a?ob:S(Ra(a)))};var mb,nb,ob=S(Ra()),pb=[],qb=0;pb.call=ab.call,pb.empty=ab.empty,pb.node=ab.node,pb.size=ab.size,Ta.transition=function(a,b){return a&&a.transition?mb?a.transition(b):a:Ta.selection().transition(a)},Ta.transition.prototype=pb,pb.select=function(a){var b,c,d,e=this.id,g=this.namespace,h=[];a=f(a);for(var i=-1,j=this.length;++i<j;){h.push(b=[]);for(var k=this[i],l=-1,m=k.length;++l<m;)(d=k[l])&&(c=a.call(d,d.__data__,l,i))?("__data__"in d&&(c.__data__=d.__data__),Sa(c,l,g,e,d[g][e]),b.push(c)):b.push(null)}return T(h,g,e)},pb.selectAll=function(a){var b,c,d,e,f,h=this.id,i=this.namespace,j=[];a=g(a);for(var k=-1,l=this.length;++k<l;)for(var m=this[k],n=-1,o=m.length;++n<o;)if(d=m[n]){f=d[i][h],c=a.call(d,d.__data__,n,k),j.push(b=[]);for(var p=-1,q=c.length;++p<q;)(e=c[p])&&Sa(e,p,i,h,f),b.push(e)}return T(j,i,h)},pb.filter=function(a){var b,c,d,e=[];"function"!=typeof a&&(a=C(a));for(var f=0,g=this.length;g>f;f++){e.push(b=[]);for(var c=this[f],h=0,i=c.length;i>h;h++)(d=c[h])&&a.call(d,d.__data__,h,f)&&b.push(d)}return T(e,this.namespace,this.id)},Ta.color=U,U.prototype.toString=function(){return this.rgb()+""},Ta.hsl=V;var rb=V.prototype=new U;rb.brighter=function(a){return a=Math.pow(.7,arguments.length?a:1),new V(this.h,this.s,this.l/a)},rb.darker=function(a){return a=Math.pow(.7,arguments.length?a:1),new V(this.h,this.s,a*this.l)},rb.rgb=function(){return W(this.h,this.s,this.l)};var sb=Math.PI,tb=2*sb,ub=sb/2,vb=sb/180,wb=180/sb;Ta.hcl=X;var xb=X.prototype=new U;xb.brighter=function(a){return new X(this.h,this.c,Math.min(100,this.l+yb*(arguments.length?a:1)))},xb.darker=function(a){return new X(this.h,this.c,Math.max(0,this.l-yb*(arguments.length?a:1)))},xb.rgb=function(){return Y(this.h,this.c,this.l).rgb()},Ta.lab=Z;var yb=18,zb=.95047,Ab=1,Bb=1.08883,Cb=Z.prototype=new U;Cb.brighter=function(a){return new Z(Math.min(100,this.l+yb*(arguments.length?a:1)),this.a,this.b)},Cb.darker=function(a){return new Z(Math.max(0,this.l-yb*(arguments.length?a:1)),this.a,this.b)},Cb.rgb=function(){return $(this.l,this.a,this.b)},Ta.rgb=da;var Db=da.prototype=new U;Db.brighter=function(a){a=Math.pow(.7,arguments.length?a:1);var b=this.r,c=this.g,d=this.b,e=30;return b||c||d?(b&&e>b&&(b=e),c&&e>c&&(c=e),d&&e>d&&(d=e),new da(Math.min(255,b/a),Math.min(255,c/a),Math.min(255,d/a))):new da(e,e,e)},Db.darker=function(a){return a=Math.pow(.7,arguments.length?a:1),new da(a*this.r,a*this.g,a*this.b)},Db.hsl=function(){return ha(this.r,this.g,this.b)},Db.toString=function(){return"#"+fa(this.r)+fa(this.g)+fa(this.b)};var Eb=Ta.map({aliceblue:15792383,antiquewhite:16444375,aqua:65535,aquamarine:8388564,azure:15794175,beige:16119260,bisque:16770244,black:0,blanchedalmond:16772045,blue:255,blueviolet:9055202,brown:10824234,burlywood:14596231,cadetblue:6266528,chartreuse:8388352,chocolate:13789470,coral:16744272,cornflowerblue:6591981,cornsilk:16775388,crimson:14423100,cyan:65535,darkblue:139,darkcyan:35723,darkgoldenrod:12092939,darkgray:11119017,darkgreen:25600,darkgrey:11119017,darkkhaki:12433259,darkmagenta:9109643,darkolivegreen:5597999,darkorange:16747520,darkorchid:10040012,darkred:9109504,darksalmon:15308410,darkseagreen:9419919,darkslateblue:4734347,darkslategray:3100495,darkslategrey:3100495,darkturquoise:52945,darkviolet:9699539,deeppink:16716947,deepskyblue:49151,dimgray:6908265,dimgrey:6908265,dodgerblue:2003199,firebrick:11674146,floralwhite:16775920,forestgreen:2263842,fuchsia:16711935,gainsboro:14474460,ghostwhite:16316671,gold:16766720,goldenrod:14329120,gray:8421504,green:32768,greenyellow:11403055,grey:8421504,honeydew:15794160,hotpink:16738740,indianred:13458524,indigo:4915330,ivory:16777200,khaki:15787660,lavender:15132410,lavenderblush:16773365,lawngreen:8190976,lemonchiffon:16775885,lightblue:11393254,lightcoral:15761536,lightcyan:14745599,lightgoldenrodyellow:16448210,lightgray:13882323,lightgreen:9498256,lightgrey:13882323,lightpink:16758465,lightsalmon:16752762,lightseagreen:2142890,lightskyblue:8900346,lightslategray:7833753,lightslategrey:7833753,lightsteelblue:11584734,lightyellow:16777184,lime:65280,limegreen:3329330,linen:16445670,magenta:16711935,maroon:8388608,mediumaquamarine:6737322,mediumblue:205,mediumorchid:12211667,mediumpurple:9662683,mediumseagreen:3978097,mediumslateblue:8087790,mediumspringgreen:64154,mediumturquoise:4772300,mediumvioletred:13047173,midnightblue:1644912,mintcream:16121850,mistyrose:16770273,moccasin:16770229,navajowhite:16768685,navy:128,oldlace:16643558,olive:8421376,olivedrab:7048739,orange:16753920,orangered:16729344,orchid:14315734,palegoldenrod:15657130,palegreen:10025880,paleturquoise:11529966,palevioletred:14381203,papayawhip:16773077,peachpuff:16767673,peru:13468991,pink:16761035,plum:14524637,powderblue:11591910,purple:8388736,rebeccapurple:6697881,red:16711680,rosybrown:12357519,royalblue:4286945,saddlebrown:9127187,salmon:16416882,sandybrown:16032864,seagreen:3050327,seashell:16774638,sienna:10506797,silver:12632256,skyblue:8900331,slateblue:6970061,slategray:7372944,slategrey:7372944,snow:16775930,springgreen:65407,steelblue:4620980,tan:13808780,teal:32896,thistle:14204888,tomato:16737095,turquoise:4251856,violet:15631086,wheat:16113331,white:16777215,whitesmoke:16119285,yellow:16776960,yellowgreen:10145074});Eb.forEach(function(a,b){Eb.set(a,ea(b))}),Ta.interpolateRgb=la,Ta.interpolateObject=ma,Ta.interpolateArray=na,Ta.interpolateNumber=oa,Ta.interpolateString=pa;var Fb=/[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,Gb=new RegExp(Fb.source,"g");Ta.interpolate=qa,Ta.interpolators=[function(a,b){var c=typeof b;return("string"===c?Eb.has(b.toLowerCase())||/^(#|rgb\(|hsl\()/i.test(b)?la:pa:b instanceof U?la:Array.isArray(b)?na:"object"===c&&isNaN(b)?ma:oa)(a,b)}],Ta.transform=function(a){var b=Wa.createElementNS(Ta.ns.prefix.svg,"g");return(Ta.transform=function(a){if(null!=a){b.setAttribute("transform",a);var c=b.transform.baseVal.consolidate()}return new ra(c?c.matrix:Hb)})(a)},ra.prototype.toString=function(){return"translate("+this.translate+")rotate("+this.rotate+")skewX("+this.skew+")scale("+this.scale+")"};var Hb={a:1,b:0,c:0,d:1,e:0,f:0};Ta.interpolateTransform=Aa,pb.tween=function(a,b){var c=this.id,d=this.namespace;return arguments.length<2?this.node()[d][c].tween.get(a):L(this,null==b?function(b){b[d][c].tween.remove(a)}:function(e){e[d][c].tween.set(a,b)})},pb.attr=function(a,b){function c(){this.removeAttribute(h)}function d(){this.removeAttributeNS(h.space,h.local)}function e(a){return null==a?c:(a+="",function(){var b,c=this.getAttribute(h);return c!==a&&(b=g(c,a),function(a){this.setAttribute(h,b(a))})})}function f(a){return null==a?d:(a+="",function(){var b,c=this.getAttributeNS(h.space,h.local);return c!==a&&(b=g(c,a),function(a){this.setAttributeNS(h.space,h.local,b(a))})})}if(arguments.length<2){for(b in a)this.attr(b,a[b]);return this}var g="transform"==a?Aa:qa,h=Ta.ns.qualify(a);return Ba(this,"attr."+a,b,h.local?f:e)},pb.attrTween=function(a,b){function c(a,c){var d=b.call(this,a,c,this.getAttribute(e));return d&&function(a){this.setAttribute(e,d(a))}}function d(a,c){var d=b.call(this,a,c,this.getAttributeNS(e.space,e.local));return d&&function(a){this.setAttributeNS(e.space,e.local,d(a))}}var e=Ta.ns.qualify(a);return this.tween("attr."+a,e.local?d:c)},pb.style=function(a,b,d){function e(){this.style.removeProperty(a)}function f(b){return null==b?e:(b+="",function(){var e,f=c(this).getComputedStyle(this,null).getPropertyValue(a);return f!==b&&(e=qa(f,b),function(b){this.style.setProperty(a,e(b),d)})})}var g=arguments.length;if(3>g){if("string"!=typeof a){2>g&&(b="");for(d in a)this.style(d,a[d],b);return this}d=""}return Ba(this,"style."+a,b,f)},pb.styleTween=function(a,b,d){function e(e,f){var g=b.call(this,e,f,c(this).getComputedStyle(this,null).getPropertyValue(a));return g&&function(b){this.style.setProperty(a,g(b),d)}}return arguments.length<3&&(d=""),this.tween("style."+a,e)},pb.text=function(a){return Ba(this,"text",a,Ca)},pb.remove=function(){var a=this.namespace;return this.each("end.transition",function(){var b;this[a].count<2&&(b=this.parentNode)&&b.removeChild(this)})};var Ib=function(){return Da},Jb=Ta.map({linear:Ib,poly:Ka,quad:function(){return Ha},cubic:function(){return Ia},sin:function(){return La},exp:function(){return Ma},circle:function(){return Na},elastic:Oa,back:Pa,bounce:function(){return Qa}}),Kb=Ta.map({"in":Da,out:Fa,"in-out":Ga,"out-in":function(a){return Ga(Fa(a))}});Ta.ease=function(a){var b=a.indexOf("-"),c=b>=0?a.slice(0,b):a,d=b>=0?a.slice(b+1):"in";return c=Jb.get(c)||Ib,d=Kb.get(d)||Da,Ea(d(c.apply(null,Ua.call(arguments,1))))},pb.ease=function(a){var b=this.id,c=this.namespace;return arguments.length<1?this.node()[c][b].ease:("function"!=typeof a&&(a=Ta.ease.apply(Ta,arguments)),L(this,function(d){d[c][b].ease=a}))},pb.delay=function(a){var b=this.id,c=this.namespace;return arguments.length<1?this.node()[c][b].delay:L(this,"function"==typeof a?function(d,e,f){d[c][b].delay=+a.call(d,d.__data__,e,f)}:(a=+a,function(d){d[c][b].delay=a}))},pb.duration=function(a){var b=this.id,c=this.namespace;return arguments.length<1?this.node()[c][b].duration:L(this,"function"==typeof a?function(d,e,f){d[c][b].duration=Math.max(1,a.call(d,d.__data__,e,f))}:(a=Math.max(1,a),function(d){d[c][b].duration=a}))},pb.each=function(a,b){var c=this.id,d=this.namespace;if(arguments.length<2){var e=nb,f=mb;try{mb=c,L(this,function(b,e,f){nb=b[d][c],a.call(b,b.__data__,e,f)})}finally{nb=e,mb=f}}else L(this,function(e){var f=e[d][c];(f.event||(f.event=Ta.dispatch("start","end","interrupt"))).on(a,b)});return this},pb.transition=function(){for(var a,b,c,d,e=this.id,f=++qb,g=this.namespace,h=[],i=0,j=this.length;j>i;i++){h.push(a=[]);for(var b=this[i],k=0,l=b.length;l>k;k++)(c=b[k])&&(d=c[g][e],Sa(c,k,g,f,{time:d.time,ease:d.ease,delay:d.delay+d.duration,duration:d.duration})),a.push(c)}return T(h,g,f)},"function"==typeof define&&define.amd?define(this.d3=Ta):"object"==typeof b&&b.exports?b.exports=Ta:this.d3=Ta}()},{}],11:[function(a,b,c){var d=(a("./lib/d3-slim-dist"),a("./manifestLayout")),e=a("./canvasUtils"),f=a("./viewerState"),g=a("./iiifUtils"),h=a("./renderState"),i=a("./osdRenderer"),j=a("./d3Renderer"),k=a("events"),l=function(a){"use strict";function b(){return H&&H.viewingDirection?H.viewingDirection:G.viewingDirection?G.viewingDirection:"left-to-right"}function c(){return H&&H.viewingHint?H.viewingHint:G.viewingHint?G.viewingHint:"individuals"}function l(a){"overview"===B.getState().perspective&&C.getState().zooming===!1&&(C.setState({lastScrollPosition:$(this).scrollTop()}),T.setViewerBoundsFromState(!0))}function m(){return B.getState()}function n(a){B.setState(a)}function o(a){var b,c=a.detail,e=B.getState(),f=(c.perspective||e.perspective,d({canvases:I,width:e.width,height:e.height,scaleFactor:e.scaleFactor,viewingDirection:e.viewingDirection,viewingMode:e.viewingMode,canvasHeight:100,canvasWidth:100,selectedCanvas:e.selectedCanvas,framePadding:{top:10,bottom:40,left:10,right:10},viewportPadding:R,minimumImageGap:5,facingCanvasPadding:.1})),g=function(a){var b=B.selectedCanvasObject(),c=b.getBounds().getTopLeft(),d=f[a](c);return d},h=function(a,b){1===c.length&&"scaleFactor"===c[0]&&(b=!1);var d=g(a);return D.renderLayout(d,b),d},i=function(a){var c="detail"===a,d=function(){S.removeListener("render-layout-complete",d),h(a,!c)};S.on("render-layout-complete",d),b=h("intermediate",c)};if("perspective"in c)i(e.perspective);else{var j="selectedCanvas"in c||"viewingMode"in c;b=h(e.perspective,j)}var k,l="perspective"in c||"selectedCanvas"in c;if("detail"===e.perspective){k=b.filter(function(a){return a.canvas.selected})[0].vantage,C.setState({constraintBounds:k});var m=new OpenSeadragon.Rect(k.x,k.y,k.width,k.height);D.setScrollElementEvents(),E.viewport.fitBounds(m,!l),T.enableZoomAndPan()}else C.setState({overviewLeft:b[0].x-f.viewport.width*f.viewport.padding.left/100,overviewTop:b[0].y-f.viewport.height*f.viewport.padding.top/100,zooming:!0}),T.disableZoomAndPan(),D.setScrollElementEvents(),T.setViewerBoundsFromState(l),setTimeout(function(){C.setState({zooming:!1}),D.setScrollElementEvents()},1200)}function p(a){B.selectedCanvasObject(a)}function q(){return B.selectedCanvasObject()}function r(a){B.setState({perspective:a})}function s(a){B.setState({viewingMode:a})}function t(a){B.setState({viewingDirection:a})}function u(){B.setState({width:J.width(),height:J.height()})}function v(a){B.setState({scaleFactor:a})}function w(a){}function x(){w(!0)}function y(){w(!1)}function z(){E&&E.destroy(),T=null,W.remove(),Y.remove(),X.remove(),B=null,C=null,D=null,F=null,U=!0}function A(a,b){S.on(a,b)}var B,C,D,E,F,G=a.manifest,H=a.sequence,I=a.sequence?a.sequence.canvases:G.sequences[0].canvases,J=a.container,K=a.viewingDirection?a.viewingDirection:b(),L=a.viewingMode?a.viewingHint:c(),M=a.perspective?a.perspective:"overview",N=a.selectedCanvas||g.getFirst(I),O=a.canvasClass||"canvas",P=a.frameClass||"frame",Q=a.labelClass||"label",R=a.viewportPadding,S=new k.EventEmitter,T=new i({dispatcher:S,renderState:C,viewerState:B}),U=!1;S.setMaxListeners(0);var V={width:"100%",height:"100%",position:"absolute",top:0,left:0},W=$('<div class="overlaysContainer">').css(V),X=$('<div class="osd-container">').css(V);V.overflow="hidden",V["overflow-x"]="hidden";var Y=$('<div class="scroll-container">').css(V);return J.append(X),J.append(Y),Y.append(W),E=T.initOSD(X),F=new e({canvases:I,dispatcher:S}),B=B||new f({dispatcher:S,canvasObjects:F.canvasObjects,selectedCanvas:N,perspective:M,viewingMode:L,viewingDirection:K,width:J.width(),height:J.height()}),C=C||new h({zooming:!1,constraintBounds:{x:0,y:0,width:J.width(),height:J.height()},inZoomConstraints:!1,lastScrollPosition:$(this).scrollTop(),overviewLeft:0,overviewTop:0}),D=new j({dispatcher:S,viewerState:B,renderState:C,scrollContainer:Y,overlays:W,canvasClass:O,frameClass:P,labelClass:Q}),T.addOSDHandlers(B,C),E.addHandler("animation",function(a){D.scaleForZoom(T.getViewerScale(),T.getZoomTranslation())}),Y.on("scroll",l),S.on("viewer-state-updated",o),{destroy:z,next:x,previous:y,resize:u,selectCanvas:p,selectPerspective:r,selectViewingMode:s,selectViewingDirection:t,updateThumbSize:v,getState:m,setState:n,osd:E,on:A,getSelectedCanvas:q}};b.exports=l},{"./canvasUtils":7,"./d3Renderer":8,"./iiifUtils":9,"./lib/d3-slim-dist":10,"./manifestLayout":12,"./osdRenderer":13,"./renderState":14,"./viewerState":15,events:1}],12:[function(a,b,c){"use strict";var d=function(a){function b(a,b,c){var d,e,f={padding:c||{top:0,left:0,right:0,bottom:0},width:a,height:b,aspectRatio:a/b};return d=f.padding.left+f.padding.right,e=f.padding.top+f.padding.bottom,f.paddedWidth=a-a*(d/100),f.paddedHeight=b-b*(e/100),f.paddedAspectRatio=f.paddedWidth/f.paddedHeight,f}function c(a,b){var c={id:a["@id"],label:a.label,height:a.height,width:a.width,aspectRatio:a.width/a.height,selected:a["@id"]===z?!0:!1,sequencePosition:b};return c}function d(a,b){var c=(a.aspectRatio<=1?!0:!1,b/a.height);return a.height=b,a.width=a.width*c,a}function e(a,b){return a.localX=b.left,a.localY=b.top,{width:a.width+b.left+b.right,height:a.height+b.top+b.bottom,canvas:a}}function f(a,b,c,d,f){if("paged"===b)return a.filter(function(a){return"non-paged"===a.viewingHint?!1:!0}).map(function(a,b){var c;return 0===b?(c={top:d.top,bottom:d.bottom,left:d.left,right:a.width*f/100/2},c.left=a.width+f/100*a.width,e(a,c)):(b+1)%2===0?(c={top:d.top,bottom:d.bottom,left:d.left,right:a.width*f/100/2},e(a,c)):(c={top:d.top,bottom:d.bottom,left:a.width*f/100/2,right:d.right},e(a,c))});if("continuous"===b){var g={top:d.top,bottom:d.bottom,left:0,right:0};return a.map(function(a){return e(a,g)})}return a.map(function(a){return e(a,d)})}function g(a){return 0===a?"firstPage":a%2===0?"rightPage":"leftPage"}function h(a,b){var c=new D(b,a);return a.map(function(a){var b=c.addItem(a);return a.x=b.x,a.y=b.y,a.canvas.x=a.x+a.canvas.localX,a.canvas.y=a.y+a.canvas.localY,a})}function i(a,b){var c=0,d=0;return a.forEach(function(a){a.canvas.selected&&(c=b.x-(a.x+a.canvas.localX),d=b.y-(a.y+a.canvas.localY))}),a.forEach(function(a){a.x+=c,a.y+=d}),a}function j(a){return a.forEach(function(a){a.canvas.x=a.x+a.canvas.localX,a.canvas.y=a.y+a.canvas.localY}),a}function k(a){var b=f(y.map(c).map(function(a){return d(a,t)}),B,A,u,v);return b=h(b,C.paddedWidth),b=i(b,a),b=j(b)}function l(a){return m(a)}function m(a){var b=f(y.map(c).map(function(a){return d(a,t)}),B,A,u,v),e=0,g=0;return b.forEach(function(a){a.x=e,a.y=g,e+=a.width}),b=i(b,a),b=j(b),b=o(b)}function n(a){return o(k(a))}function o(a){var b=a.filter(function(a){return a.canvas.selected}),c=b[0],d=s(c.canvas,a),e=c.canvas.sequencePosition;return c.vantage=p(c.canvas,d),"continuous"!==B&&a.forEach(function(a,b,f){if(a.y===c.y&&a.canvas.id!==c.canvas.id){if("paged"===B&&a.canvas.id===d.id)return;e>b?a.x=a.x-(c.vantage.leftMargin+2*u.right):a.x=a.x+(c.vantage.rightMargin+2*u.left)}else a.y>c.y?a.y=a.y+(c.vantage.topMargin+2*u.bottom):a.y<c.y&&(a.y=a.y-(c.vantage.bottomMargin+2*u.top))}),a=j(a)}function p(a,b){var c,d,e,f={};if("paged"===B){var g=a.sequencePosition;0===g?(c=2*a.width,d=a.x-a.width,e=a.height):g%2===0?(c=a.width+b.width,c+=v/100*c,d=b.x,e=Math.max(a.height,b.height)):(c=a.width+b.width,c+=v/100*c,d=a.x,e=Math.max(a.height,b.height)),f={x:d,y:a.y,width:c,height:e}}else d=a.x,f={x:a.x,y:a.y,width:a.width,height:a.height};return q(f)}function q(a){var b,c,d,e,f=a.width/a.height,g=5;C.paddedAspectRatio>=f?(c=100*a.height/(100-2*g),b=c*C.paddedAspectRatio):(b=100*a.width/(100-2*g),c=b/C.paddedAspectRatio),d=(b-a.width)/2,e=(c-a.height)/2;var h={x:a.x-d,y:a.y-e,width:b,height:c,topMargin:e,bottomMargin:e,leftMargin:d,rightMargin:d};return r(h)}function r(a){var b=C.padding.left+C.padding.right,c=C.padding.top+C.padding.bottom,d=100*a.width/(100-b),e=100*a.height/(100-c),f={x:a.x-d*(C.padding.left/100),y:a.y-e*(C.padding.top/100),width:d,height:e,topMargin:a.topMargin+e*C.padding.top/100,bottomMargin:a.bottomMargin+e*C.padding.bottom/100,leftMargin:a.leftMargin+d*(C.padding.left/100),rightMargin:a.rightMargin+d*(C.padding.right/100)};return f}function s(a,b){var c;return b.forEach(function(b,d){b.canvas.id===a.id&&(c=d)}),0===c?a.id:c===b.length-1?b[c].canvas:(c+1)%2===0?b[c+1].canvas:b[c-1].canvas}var t=(a.maxCanvasHeight||130,a.maxCanvasWidth||30,a.minCanvasWidth||30,a.minCanvasHeight||30,a.canvasHeight*a.scaleFactor||100),u=(a.canvasWidth*a.scaleFactor||30,a.scaleFactor||1,a.columns||8,{top:a.framePadding.top||0,bottom:a.framePadding.bottom||0,left:a.framePadding.left||0,right:a.framePadding.right||0}),v=a.facingCanvasPadding,w=(a.minimumImageGap,a.height),x=a.width,y=a.canvases,z=a.selectedCanvas,A=(a.framingStrategy||"contain",a.viewingDirection||"left-to-right"),B=a.viewingMode||"individuals",C=(a.viewingMode||"grid",b(x,w,a.viewportPadding)),D=function(a,b){this.x=0,this.y=0,this.lineWidth=a,this.frames=b};return D.prototype={_getFacingFrame:function(a){var b=g(a);return"leftPage"===b?this.frames[a+1]:"rightPage"===b?this.frames[a-1]:null},addItem:function(a){var b=a.width;if("paged"===B){var c=this._getFacingFrame(a.canvas.sequencePosition);c&&(c.canvas.sequencePosition>a.canvas.sequencePosition?b+=c.width:b=0)}this.x+b>this.lineWidth&&(this.x=0,this.y+=a.height);var d={x:this.x,y:this.y};return this.x+=a.width,"right-to-left"===A&&(d.x=this.lineWidth-this.x),d}},{overview:k,intermediate:n,detail:l,viewport:C}};b.exports=d},{}],13:[function(a,b,c){a("openseadragon");var d=function(a){var b=this;this.dispatcher=a.dispatcher,this.renderState=a.renderState,this.viewerState=a.viewerState,this.scrollContainer=a.scrollContainer,this.dispatcher.on("canvas-position-updated",function(a){a.images.forEach(function(a){b.updateImagePosition(a)})}),this.dispatcher.on("image-needed",function(a){b.openTileSource(a)}),this.dispatcher.on("image-show",function(a){"drawn"===a.getStatus()&&b.updateImageOpacity(a)}),this.dispatcher.on("image-hide",function(a){"drawn"===a.getStatus()&&a.osdTiledImage.setOpacity(0)}),this.dispatcher.on("image-opacity-updated",function(a){"drawn"===a.getStatus()&&b.updateImageOpacity(a)})};d.prototype={initOSD:function(a){return this.viewer=OpenSeadragon({element:a[0],showNavigationControl:!1,preserveViewport:!0}),this.viewer},tileSourceConfig:function(a){},updateItemIndex:function(){this.tiledImage&&this.viewer.world.getItemCount()>this.zIndex&&this.viewer.world.setItemIndex(this.tiledImage,this.zIndex)},getTileSourceFromImageResource:function(){return{}},removeThumbnail:function(a){a.thumbnail&&(a.thumbnail.fade(0),a.thumbnail.removeFromCanvas(),a.thumbnail.destroy(),delete a.thumbnail)},removeTilesource:function(a){this.tiledImage&&(this.viewer.world.removeItem(this.tiledImage),this.tiledImage=null)},updateImageOpacity:function(a){a.osdTiledImage&&a.osdTiledImage.setOpacity(a.opacity*a.parent.getOpacity())},openTileSource:function(a,b){var c=this;if("drawn"!==a.status){a.setStatus("requested");var d=a.getGlobalBounds();this.viewer.addTiledImage({x:d.x,y:d.y,width:d.width,tileSource:a.tileSource,opacity:a.opacity,clip:a.clipRegion,index:a.zIndex,success:function(b){var d=b.item;a.osdTiledImage=d,a.setStatus("loaded"),c.syncAllImageProperties(a);var e=function(b){b.tiledImage===d&&(a.setStatus("drawn"),c.viewer.removeHandler("tile-drawn",e))};c.viewer.addHandler("tile-drawn",e)},error:function(b){a.setStatus("failed")}})}},syncAllImageProperties:function(a){var b=this;if(a.osdTiledImage){var c=a.getGlobalBounds();a.osdTiledImage.setPosition({x:c.x,y:c.y},!0),a.osdTiledImage.setWidth(c.width,!0),a.osdTiledImage.setOpacity(a.getOpacity()*a.parent.getOpacity()),b.updateImageLayeringIndex(a)}},updateImageLayeringIndex:function(a){},updateImagePosition:function(a){if(a.osdTiledImage){var b=a.getGlobalBounds();b=new OpenSeadragon.Rect(b.x,b.y,b.width,b.height),a.osdTiledImage.setPosition(b.getTopLeft(),!0),a.osdTiledImage.setWidth(b.width,!0)}},fadeTilesource:function(a,b,c){var d=this,e=(b-currentOpacity)/30;if(0===e)return void(c&&c());var f=function(){return a+=e,e>0&&a>=b||0>e&&b>=a?(d.setOpacity(b),void(c&&c())):(d.setOpacity(a),void OpenSeadragon.requestAnimationFrame(f))};OpenSeadragon.requestAnimationFrame(f)},disableZoomAndPan:function(){this.viewer.zoomPerClick=1,this.viewer.zoomPerScroll=1,this.viewer.panHorizontal=!1,this.viewer.panVertical=!1},enableZoomAndPan:function(){this.viewer.zoomPerClick=2,this.viewer.zoomPerScroll=1.2,this.viewer.panHorizontal=!0,this.viewer.panVertical=!0},setViewerBoundsFromState:function(a){if(this.viewer){var b=this.renderState.getState(),c=this.viewerState.getState(),d=new OpenSeadragon.Rect(b.overviewLeft,b.overviewTop+b.lastScrollPosition,c.width,c.height);this.viewer.viewport.fitBounds(d,a)}},getViewerScale:function(){var a=this.viewer.viewport.getZoom(!0),b=this.viewer.container.clientWidth;return b*a},getZoomTranslation:function(){var a=this.viewer.container.clientWidth,b=this.viewer.container.clientHeight,c=this.viewer.viewport.getCenter(!0),d=c.minus(new OpenSeadragon.Point(a/2,b/2)).minus(new OpenSeadragon.Point(0,this.renderState.getState().lastScrollPosition));return d},addOSDHandlers:function(a,b){this.viewerState=a,this.renderState=b;var c=this,d=function(){var a=c.renderState.getState(),b=new OpenSeadragon.Rect(a.constraintBounds.x,a.constraintBounds.y,a.constraintBounds.width,a.constraintBounds.height);if(b&&!a.inZoomConstraints){var d=!1,e=c.viewer.viewport.getBounds();e.x<b.x-1e-5&&(e.x=b.x,d=!0),e.y<b.y-1e-5&&(e.y=b.y,d=!0),e.width>b.width+1e-5&&(e.width=b.width,d=!0),e.height>b.height+1e-5&&(e.height=b.height,d=!0),e.x+e.width>b.x+b.width+1e-5&&(e.x=b.x+b.width-e.width,d=!0),e.y+e.height>b.y+b.height+1e-5&&(e.y=b.y+b.height-e.height,d=!0),d&&(c.renderState.setState({inZoomConstraints:!0}),c.viewer.viewport.fitBounds(b),c.renderState.setState({inZoomConstraints:!1}))}var f=c.viewer.viewport.getZoom(),g=2;f>g&&(c.viewer.viewport.zoomSpring.target.value=g)};this.viewer.addHandler("zoom",function(a){"detail"===c.viewerState.getState().perspective&&d();c.viewer.viewport.getBounds().getCenter()}),this.viewer.addHandler("pan",function(a){"detail"===c.viewerState.getState().perspective&&d();c.viewer.viewport.getZoom()})}},b.exports=d},{openseadragon:2}],14:[function(a,b,c){var d=function(a){this.state={zooming:a.zooming,constraintBounds:a.constraintBounds,inZoomConstraints:a.inZoomConstraints,lastScrollPosition:a.lastScrollPosition,overviewLeft:a.overviewLeft,overviewTop:a.overviewTop}};d.prototype={getState:function(){return this.state},setState:function(a){for(var b in a)a.hasOwnProperty(b)&&this.state[b]!==a[b]&&(this.state[b]=a[b])}},b.exports=d},{}],15:[function(a,b,c){var d=(a("./canvasUtils"),function(a){this.dispatcher=a.dispatcher,this.state={canvasObjects:a.canvasObjects,selectedCanvas:a.selectedCanvas,perspective:a.perspective,viewingMode:a.viewingMode,viewingDirection:a.viewingDirection,width:a.width,height:a.height}});d.prototype={getState:function(){return this.state},setState:function(a){console.log("started");var b={};for(var c in a)a.hasOwnProperty(c)&&this.state[c]!==a[c]&&(b[c]=this.state[c],this.state[c]=a[c]);this.dispatcher.emit("viewer-state-updated",{detail:b})},selectedCanvasObject:function(a){return console.log("canvasSet"),arguments.length?(this.setState({selectedCanvas:a,perspective:"detail"}),this.state.canvasObjects[this.state.selectedCanvas].images.filter(function(a){return console.log(a.getImageType()),"main"===a.getImageType()}).forEach(function(a){console.log("deep in the forEach"),console.log(a),a.show()}),this.dispatcher.emit("canvas-selected",{detail:a}),this.state.canvasObjects[this.state.selectedCanvas]):this.state.canvasObjects[this.state.selectedCanvas]}},b.exports=d},{"./canvasUtils":7}]},{},[11])(11)});